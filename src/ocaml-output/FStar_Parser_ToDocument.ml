...
let matches_level :
  'Auu____1651 .
    Prims.string ->
      ('Auu____1651 * (FStar_Char.char,Prims.string) FStar_Util.either
...
let max_level :
  'Auu____2127 . ('Auu____2127 * token Prims.list) Prims.list -> Prims.int =
  fun l  ->
...
let handleable_op :
  'Auu____2643 . FStar_Ident.ident -> 'Auu____2643 Prims.list -> Prims.bool =
  fun op  ->
    fun args  ->
      match FStar_List.length args with
      | _2659 when _2659 = Prims.int_zero -> true
      | _2661 when _2661 = Prims.int_one ->
          (is_general_prefix_op op) ||
            (let uu____2663 = FStar_Ident.text_of_id op  in
             FStar_List.mem uu____2663 ["-"; "~"])
      | _2671 when _2671 = (Prims.of_int (2)) ->
          ((is_operatorInfix0ad12 op) || (is_operatorInfix34 op)) ||
            (let uu____2673 = FStar_Ident.text_of_id op  in
             FStar_List.mem uu____2673
               ["<==>"; "==>"; "\\/"; "/\\"; "="; "|>"; ":="; ".()"; ".[]"])
      | _2695 when _2695 = (Prims.of_int (3)) ->
...
let with_comment :
  'Auu____3031 .
    ('Auu____3031 -> FStar_Pprint.document) ->
      'Auu____3031 -> FStar_Range.range -> FStar_Pprint.document
  =
  fun printer  ->
    fun tm  ->
      fun tmrange  ->
...
let with_comment_sep :
  'Auu____3234 'Auu____3235 .
    ('Auu____3234 -> 'Auu____3235) ->
      'Auu____3234 ->
        FStar_Range.range -> (FStar_Pprint.document * 'Auu____3235)
  =
  fun printer  ->
    fun tm  ->
      fun tmrange  ->
...
let separate_map_with_comments :
  'Auu____3644 .
    FStar_Pprint.document ->
      FStar_Pprint.document ->
        ('Auu____3644 -> FStar_Pprint.document) ->
          'Auu____3644 Prims.list ->
            ('Auu____3644 -> decl_meta) -> FStar_Pprint.document
  =
  fun prefix1  ->
    fun sep  ->
      fun f  ->
            ...
            | (x,xs1) ->
                let init1 =
                  ...
                  let uu____3762 =
                    ...
                    FStar_Pprint.op_Hat_Hat prefix1 uu____3763  in
                  (uu____3759, uu____3762)  in
                let uu____3765 = FStar_List.fold_left fold_fun init1 xs1  in
...
let separate_map_with_comments_kw :
  'Auu____3792 'Auu____3793 .
    'Auu____3792 ->
      'Auu____3792 ->
        ('Auu____3792 -> 'Auu____3793 -> FStar_Pprint.document) ->
          'Auu____3793 Prims.list ->
            ('Auu____3793 -> decl_meta) -> FStar_Pprint.document
  =
  fun prefix1  ->
    fun sep  ->
      fun f  ->
          ...
          fun extract_meta  ->
            ...
            | (x,xs1) ->
                let init1 =
                  ...
                  let uu____3915 = f prefix1 x  in (uu____3912, uu____3915)
                   in
                let uu____3917 = FStar_List.fold_left fold_fun init1 xs1  in
    ...
    let qualifiers =
      ...
      | ((FStar_Parser_AST.Assumption )::[],FStar_Parser_AST.Assume
         (id1,uu____4873)) ->
          let uu____4876 =
            let uu____4878 =
              let uu____4880 = FStar_Ident.text_of_id id1  in
  ...
  fun d  ->
    ...
    | FStar_Parser_AST.Assume (id1,t) ->
        let decl_keyword =
          let uu____5126 =
            let uu____5128 =
              let uu____5130 = FStar_Ident.text_of_id id1  in
  ...
  fun p  ->
    ...
    | FStar_Parser_AST.PatApp
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatName maybe_cons_lid;
           FStar_Parser_AST.prange = uu____6235;_},hd1::tl1::[])
        when
        FStar_Ident.lid_equals maybe_cons_lid FStar_Parser_Const.cons_lid ->
        let uu____6240 =
          FStar_Pprint.op_Hat_Hat FStar_Pprint.colon FStar_Pprint.colon  in
        let uu____6241 = p_constructorPattern hd1  in
        let uu____6242 = p_constructorPattern tl1  in
...
and (is_typ_tuple : FStar_Parser_AST.term -> Prims.bool) =
  fun e  ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op (id1,uu____6410) when
        let uu____6415 = FStar_Ident.text_of_id id1  in uu____6415 = "*" ->
        true
    | uu____6420 -> false
  ...
  fun ps  ->
    fun pb  ->
      fun e  ->
        ...
        | FStar_Parser_AST.Op (id1,e1::e2::e3::[]) when
            let uu____6927 = FStar_Ident.text_of_id id1  in
            uu____6927 = ".()<-" ->
            let uu____6931 =
              let uu____6932 =
                let uu____6933 =
        ...
        | FStar_Parser_AST.Op (id1,e1::e2::e3::[]) when
            let uu____6950 = FStar_Ident.text_of_id id1  in
            uu____6950 = ".[]<-" ->
            let uu____6954 =
              let uu____6955 =
                let uu____6956 =
        ...
        | FStar_Parser_AST.CalcProof (rel,init1,steps) ->
            ...
            let uu____7448 =
              let uu____7449 =
                let uu____7450 =
                  let uu____7451 = p_noSeqTermAndComment false false init1
                     in
                  let uu____7454 =
              ...
              FStar_All.pipe_left (FStar_Pprint.nest (Prims.of_int (2)))
                uu____7449
               in
            FStar_Pprint.enclose head1 uu____7447 uu____7448
                 ...
                 FStar_List.fold_left
                   (fun x  ->
                      fun y  ->
                        ...
                        FStar_Pprint.op_Hat_Hat x uu____7885) hd1 tl1
                  in
                   ...
                   then
                     let uu____8210 =
                       ...
                       FStar_Pprint.op_Hat_Hat FStar_Pprint.hardline
                         uu____8211
                        in
                     FStar_Pprint.op_Hat_Hat prefix1 uu____8210
                   else
                     (let uu____8215 = op_Hat_Slash_Plus_Hat prefix1 doc  in
...
and (p_tmIff : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op (id1,e1::e2::[]) when
        let uu____8323 = FStar_Ident.text_of_id id1  in uu____8323 = "<==>"
        ->
...
and (p_tmImplies : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun e  ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op (id1,e1::e2::[]) when
        let uu____8338 = FStar_Ident.text_of_id id1  in uu____8338 = "==>" ->
                ...
                | Arrows (n1,ln) ->
                    ...
                    let uu____8422 =
                      FStar_Pprint.op_Hat_Hat FStar_Pprint.rarrow
                        FStar_Pprint.space
                       in
                    (n1, ln, terms', uu____8420, uu____8422)
                | Binders (n1,ln,parens1) ->
                    ...
                    let uu____8444 =
                      FStar_Pprint.op_Hat_Hat FStar_Pprint.colon
                        FStar_Pprint.space
                       in
                    (n1, ln, uu____8436, break1, uu____8444)
                 in
              (match uu____8385 with
               | (n1,last_n,terms'1,sep,last_op) ->
                   ...
                   (match FStar_List.length terms with
                    | _8477 when _8477 = Prims.int_one -> FStar_List.hd terms
                    | uu____8478 ->
                        let uu____8479 =
                          let uu____8480 =
                            let uu____8481 =
                          ...
                          let uu____8485 =
                            ...
                            FStar_Pprint.prefix n1 Prims.int_one uu____8486
                              uu____8502
                             in
                             ...
                             fun y  ->
                               let uu____9136 =
                                 FStar_Pprint.op_Hat_Hat FStar_Pprint.space y
                                  in
                               FStar_Pprint.op_Hat_Hat x uu____9136) hd1 tl1
                         in
                      f uu____9130 typ))
         in
      let binders =
...
and (p_tmDisjunction :
  ...
  fun e  ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op (id1,e1::e2::[]) when
        let uu____9245 = FStar_Ident.text_of_id id1  in uu____9245 = "\\/" ->
...
and (p_tmConjunction :
  ...
  fun e  ->
    match e.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Op (id1,e1::e2::[]) when
        let uu____9284 = FStar_Ident.text_of_id id1  in uu____9284 = "/\\" ->
  ...
  fun p_X  ->
    fun curr  ->
      fun e  ->
            ...
            (match uu____9368 with
             | (left1,mine,right1) ->
                 let uu____9387 =
                   ...
                   let uu____9390 = p_tmEqWith' p_X left1 e1  in
                   let uu____9391 = p_tmEqWith' p_X right1 e2  in
                   infix0 uu____9388 uu____9390 uu____9391  in
                 paren_if_gt curr mine uu____9387)
        | FStar_Parser_AST.Op (id1,e1::e2::[]) when
            let uu____9397 = FStar_Ident.text_of_id id1  in uu____9397 = ":="
            ->
            let uu____9401 =
        ...
        | FStar_Parser_AST.Op (id1,e1::[]) when
            let uu____9411 = FStar_Ident.text_of_id id1  in uu____9411 = "-"
            ->
    ...
    fun p_X  ->
      fun curr  ->
        fun e  ->
              ...
              (match uu____9511 with
               | (left1,mine,right1) ->
                   let uu____9530 =
                     ...
                     let uu____9532 = p_tmNoEqWith' false p_X left1 e1  in
                     let uu____9534 = p_tmNoEqWith' false p_X right1 e2  in
              ...
              (match uu____9553 with
               | (left1,mine,right1) ->
                   let p_dsumfst bt =
                     ...
                     | FStar_Util.Inr t ->
                         let uu____9593 = p_tmNoEqWith' false p_X left1 t  in
                         let uu____9595 =
                           let uu____9596 =
                   ...
                   let uu____9598 =
                     ...
                     let uu____9604 = p_tmNoEqWith' false p_X right1 res  in
                     FStar_Pprint.op_Hat_Hat uu____9599 uu____9604  in
                   paren_if_gt curr mine uu____9598)
          | FStar_Parser_AST.Op (id1,e1::e2::[]) when
              (let uu____9613 = FStar_Ident.text_of_id id1  in
              ...
              (match uu____9641 with
               | (left1,mine,right1) ->
                   ...
                   then
                     ...
                     let uu____9662 = p_tmNoEqWith' true p_X left1 e1  in
                     let uu____9664 = p_tmNoEqWith' true p_X right1 e2  in
                     infix0 uu____9661 uu____9662 uu____9664
                   else
                     (let uu____9668 =
                        let uu____9669 = str op  in
                        let uu____9670 = p_tmNoEqWith' true p_X left1 e1  in
                        let uu____9672 = p_tmNoEqWith' true p_X right1 e2  in
              ...
              (match uu____9681 with
               | (left1,mine,right1) ->
                   let uu____9700 =
                     ...
                     let uu____9702 = p_tmNoEqWith' false p_X left1 e1  in
                     let uu____9704 = p_tmNoEqWith' false p_X right1 e2  in
          ...
          | FStar_Parser_AST.Op (id1,e1::[]) when
              let uu____9736 = FStar_Ident.text_of_id id1  in
              uu____9736 = "~" ->
              let uu____9740 =
          ...
          | FStar_Parser_AST.Paren p when inside_tuple ->
              (match p.FStar_Parser_AST.tm with
               | FStar_Parser_AST.Op (id1,e1::e2::[]) when
                   let uu____9750 = FStar_Ident.text_of_id id1  in
                   uu____9750 = "*" ->
                   let op = "*"  in
                   ...
                   (match uu____9757 with
                    | (left1,mine,right1) ->
                        let uu____9776 =
                          ...
                          let uu____9778 = p_tmNoEqWith' true p_X left1 e1
                             in
                          let uu____9780 = p_tmNoEqWith' true p_X right1 e2
                             in
                  ...
                  let uu____9902 =
                    let uu____9903 =
                      let uu____9904 =
                        ...
                        let uu____9907 =
                          let uu____9908 = p_indexingTerm head1  in
              ...
              | uu____9912 ->
                  let uu____9919 =
                    ...
                    then
                      ...
                      | (fs_typ_args,args1) ->
                          let uu____10032 =
                            let uu____10033 = p_indexingTerm head1  in
                            let uu____10034 =
                              let uu____10035 =
                      ...
                      (let uu____10050 = p_indexingTerm head1  in
                       (uu____10050, args))
                     in
             ...
             let uu____10132 =
               let uu____10133 =
                 let uu____10134 =
                   ...
                   let uu____10136 = p_argTerm hd1  in
...
and (p_indexingTerm_aux :
  ...
  fun exit1  ->
    fun e  ->
      match e.FStar_Parser_AST.tm with
      | FStar_Parser_AST.Op (id1,e1::e2::[]) when
          let uu____10189 = FStar_Ident.text_of_id id1  in
          uu____10189 = ".()" ->
          let uu____10193 =
      ...
      | FStar_Parser_AST.Op (id1,e1::e2::[]) when
          let uu____10205 = FStar_Ident.text_of_id id1  in
          uu____10205 = ".[]" ->
          let uu____10209 =
...
and (p_universeFrom : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u  ->
    ...
    | FStar_Parser_AST.Op (id1,u1::u2::[]) when
        let uu____10863 = FStar_Ident.text_of_id id1  in uu____10863 = "+" ->
        let uu____10867 =
...
and (p_atomicUniverse : FStar_Parser_AST.term -> FStar_Pprint.document) =
  fun u  ->
    ...
    | FStar_Parser_AST.Uvar id1 ->
        let uu____10953 = FStar_Ident.text_of_id id1  in str uu____10953
    ...
    | FStar_Parser_AST.Op (id1,uu____10966::uu____10967::[]) when
        let uu____10970 = FStar_Ident.text_of_id id1  in uu____10970 = "+" ->
