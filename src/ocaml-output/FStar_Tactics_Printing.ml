  ...
  fun bs  ->
    fun t  ->
      ...
      let rec go seen subst1 bs1 bs' t1 =
        match bs1 with
        | [] ->
            let uu____229 = FStar_Syntax_Subst.subst subst1 t1  in
            ((FStar_List.rev bs'), uu____229)
        | b::bs2 ->
            let b1 =
              let uu____273 = FStar_Syntax_Subst.subst_binders subst1 [b]  in
             ...
             | (bv0,q) ->
                 ...
                 let uu____362 =
                   let uu____365 =
                     ...
                     [uu____368]  in
                   FStar_List.append subst1 uu____365  in
        ...
        fun g  ->
          ...
          let num =
            ...
            | FStar_Pervasives_Native.Some (i,n1) ->
                ...
                let uu____478 = FStar_Util.string_of_int n1  in
