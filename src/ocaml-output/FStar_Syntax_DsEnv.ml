...
let (set_bv_range :
  ...
  fun bv  ->
    fun r  ->
      let id1 = FStar_Ident.set_id_range r bv.FStar_Syntax_Syntax.ppname  in
  ...
  fun id1  ->
    FStar_Util.find_map unmangleMap
      (fun uu____2880  ->
         ...
         | (x,y,dd,dq) ->
             let uu____2907 =
               let uu____2909 = FStar_Ident.text_of_id id1  in uu____2909 = x
                in
             if uu____2907
             then
               let uu____2915 =
                 let uu____2916 =
                   let uu____2917 = FStar_Ident.range_of_id id1  in
          ...
          then
            let fname =
              let uu____3112 =
                ...
                FStar_List.append uu____3113 [id1]  in
            ...
            let find1 =
              FStar_Util.find_map record.fields
                (fun uu____3127  ->
                   ...
                   | (f,uu____3135) ->
                       let uu____3136 =
                         let uu____3138 = FStar_Ident.text_of_id id1  in
    ...
    fun find_in_module  ->
      fun find_in_module_default  ->
        fun env  ->
          fun ns  ->
            fun id1  ->
              let idstr = FStar_Ident.text_of_id id1  in
              let rec aux uu___3_3291 =
                ...
                | modul::q ->
                    ...
                    let not_shadowed =
                      let uu____3304 = get_exported_id_set env mname  in
                    ...
                    let look_into =
                      if not_shadowed
                      then
                        let uu____3448 = qual modul id1  in
                ...
                fun lookup_default_id  ->
                  let check_local_binding_id uu___5_3589 =
                    ...
                    | (id',uu____3592,uu____3593) ->
                        ...
                        let uu____3596 = FStar_Ident.text_of_id id1  in
                  ...
                  let check_rec_binding_id uu___6_3605 =
                    ...
                    | (id',uu____3608,uu____3609,uu____3610) ->
                        ...
                        let uu____3613 = FStar_Ident.text_of_id id1  in
                        uu____3611 = uu____3613
                     in
                  let curmod_ns =
                    let uu____3617 = current_module env  in
                  ...
                  let proc uu___7_3625 =
                    ...
                    | Local_binding l when check_local_binding_id l ->
                        ...
                        (match uu____3629 with
                         | (uu____3632,uu____3633,used_marker) ->
                             (FStar_ST.op_Colon_Equals used_marker true;
                              k_local_binding l))
                    | Rec_binding r when check_rec_binding_id r ->
                        let uu____3659 = r  in
                        (match uu____3659 with
                         | (uu____3662,uu____3663,uu____3664,used_marker) ->
                             (FStar_ST.op_Colon_Equals used_marker true;
                              k_rec_binding r))
                    ...
                    | Top_level_def id' when
                        ...
                        let uu____3693 = FStar_Ident.text_of_id id1  in
                    ...
                    | Record_or_dc r when is_exported_id_field eikind ->
                        ...
                        find_in_module_with_includes Exported_id_field
                          (fun lid  ->
                             let id2 = FStar_Ident.ident_of_lid lid  in
                             let uu____3703 = FStar_Ident.ns_of_lid lid  in
                             find_in_record uu____3703 id2 r k_record)
                          Cont_ignore env uu____3697 id1
                    | uu____3706 -> Cont_ignore  in
                  let rec aux uu___8_3716 =
                    match uu___8_3716 with
                    | a::q ->
                        let uu____3725 = proc a  in
                        option_of_cont (fun uu____3729  -> aux q) uu____3725
                    | [] ->
                        let uu____3730 = lookup_default_id Cont_fail id1  in
                        option_of_cont
...
let found_local_binding :
  'Auu____3744 'Auu____3745 .
    FStar_Range.range ->
      ('Auu____3744 * FStar_Syntax_Syntax.bv * 'Auu____3745) ->
...
let find_in_module :
  'Auu____3782 .
    env ->
      FStar_Ident.lident ->
        (FStar_Ident.lident ->
           (FStar_Syntax_Syntax.sigelt * Prims.bool) -> 'Auu____3782)
          -> 'Auu____3782 -> 'Auu____3782
  =
  fun env  ->
    fun lid  ->
      fun k_global_def  ->
        fun k_not_found  ->
          let uu____3823 =
            ...
            FStar_Util.smap_try_find (sigmap env) uu____3831  in
...
let (try_lookup_id :
  ...
  fun env  ->
    fun id1  ->
      let uu____3869 = unmangleOpName id1  in
      ...
      | uu____3875 ->
          try_lookup_id'' env id1 Exported_id_term_type
            (fun r  ->
               let uu____3881 =
                 let uu____3882 = FStar_Ident.range_of_id id1  in
    ...
    fun id1  ->
      fun k_global_def  ->
        fun k_not_found  ->
          let find_in_monad =
            ...
            | FStar_Pervasives_Native.Some uu____3977 ->
                ...
                let uu____3979 =
                  ...
                  FStar_Util.smap_try_find (sigmap env) uu____3987  in
          ...
          | FStar_Pervasives_Native.None  ->
              let lid =
                let uu____4033 = current_module env  in qual uu____4033 id1
                 in
    ...
    fun lid  ->
      fun honor_ns  ->
        ...
        let rec aux uu___9_4108 =
          ...
          | [] ->
              let uu____4113 = module_is_defined env lid  in
              if uu____4113
          ...
          | (Open_module_or_namespace (ns,Open_namespace ))::q when honor_ns
              ...
              let uu____4136 = module_is_defined env new_lid  in
              if uu____4136
      ...
      fun open_kind  ->
        FStar_List.existsb
          (fun uu___10_4182  ->
             ...
             | uu____4186 -> false) env.scope_mods
                ...
                fun l_default  ->
                  ...
                  | uu____4640::uu____4641 ->
                      let uu____4644 =
                        ...
                        resolve_module_name env uu____4647 true  in
                       ...
                       | FStar_Pervasives_Native.Some modul ->
                           let uu____4655 =
                             ...
                             find_in_module_with_includes eikind f_module
                               Cont_fail env modul uu____4658
                              in
                           option_of_cont
                  ...
                  | [] ->
                      ...
                      try_lookup_id'' env uu____4661 eikind k_local_binding
...
let (try_lookup_effect_name' :
  ...
  fun exclude_interf  ->
    fun env  ->
      fun lid  ->
        let uu____5590 = try_lookup_name true exclude_interf env lid  in
...
let (is_effect_name : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun lid  ->
      let uu____5811 = try_lookup_effect_name env lid  in
      ...
      | FStar_Pervasives_Native.Some
          ...
          let rec aux new_name =
            let uu____5873 =
              ...
              FStar_Util.smap_try_find (sigmap env) uu____5881  in
...
let (try_lookup_lid' :
  ...
  fun any_val  ->
    fun exclude_interface  ->
      fun env  ->
        fun lid  ->
          let uu____6400 = try_lookup_name any_val exclude_interface env lid
             in
...
let (try_lookup_lid :
  ...
  fun env  ->
    fun l  ->
      let uu____6521 = try_lookup_lid_with_attributes env l  in
...
let (resolve_to_fully_qualified_name :
  ...
  fun env  ->
    fun l  ->
      let uu____6553 = try_lookup_lid env l  in
  ...
  fun env  ->
    fun lid  ->
      let uu____6578 =
        ...
        shorten_module_path env uu____6587 true  in
  ...
  fun env  ->
    fun lid  ->
      ...
      | uu____6613 ->
          ...
          let uu____6618 = resolve_to_fully_qualified_name env lid_without_ns
             in
          (match uu____6618 with
           ...
           | uu____6627 -> shorten_lid' env lid)
...
let (try_lookup_lid_no_resolve :
  ...
  fun env  ->
    fun l  ->
      let uu____6674 = try_lookup_lid_with_attributes_no_resolve env l  in
              ...
              (FStar_List.iter
                 (fun uu___27_8391  ->
                    ...
                    | {
                        FStar_Syntax_Syntax.sigel =
                          FStar_Syntax_Syntax.Sig_inductive_typ
                          (typename,univs1,parms,uu____8395,uu____8396,dc::[]);
                        ...
                        (match uu____8415 with
                         | {
                             FStar_Syntax_Syntax.sigel =
                               FStar_Syntax_Syntax.Sig_datacon
                               (constrname,uu____8422,t,uu____8424,n1,uu____8426);
                             ...
                             (match uu____8444 with
                              | (all_formals,uu____8452) ->
                                  let uu____8457 =
                                    FStar_Util.first_N n1 all_formals  in
...
let (try_lookup_record_by_field_name :
  ...
  fun env  ->
    fun fieldname  ->
      let uu____8934 = try_lookup_record_or_dc_by_field_name env fieldname
         in
...
let (belongs_to_record :
  ...
  fun env  ->
    fun lid  ->
      fun record  ->
        let uu____8960 = try_lookup_record_by_field_name env lid  in
...
let (try_lookup_dc_by_field_name :
  ...
  fun env  ->
    fun fieldname  ->
      let uu____9008 = try_lookup_record_or_dc_by_field_name env fieldname
         in
...
let (push_bv : env -> FStar_Ident.ident -> (env * FStar_Syntax_Syntax.bv)) =
  fun env  ->
    fun x  ->
      let uu____9228 = push_bv' env x  in
      match uu____9228 with | (env1,bv,uu____9241) -> (env1, bv)
      ...
      fun s  ->
        let err l =
          let sopt =
            ...
            FStar_Util.smap_try_find (sigmap env) uu____9348  in
          let r =
            match sopt with
          ...
          | FStar_Syntax_Syntax.Sig_bundle (ses,uu____9528) ->
              let uu____9537 =
                FStar_List.map
                 ...
                 in
              (env2, uu____9537)
          | uu____9564 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)])
           in
...
let (push_namespace : env -> FStar_Ident.lident -> env) =
  fun env  ->
    fun ns  ->
      let uu____9852 =
        let uu____9857 = resolve_module_name env ns false  in
...
let (push_include : env -> FStar_Ident.lident -> env) =
  fun env  ->
    fun ns  ->
      let ns0 = ns  in
      let uu____9948 = resolve_module_name env ns false  in
          ...
          ((env.ds_hooks).ds_push_include_hook env ns1;
           (let env1 =
              push_scope_mod env
               ...
               in
            let curmod =
              let uu____9957 = current_module env1  in
              FStar_Ident.string_of_lid uu____9957  in
            (let uu____9959 = FStar_Util.smap_try_find env1.includes curmod
                in
            ...
            (match () with
             | () ->
                 let uu____10035 =
                   ...
                   get_trans_exported_id_set env1 uu____10043  in
                 (match uu____10035 with
                  | FStar_Pervasives_Native.Some ns_trans_exports ->
                      ((let uu____10057 =
                          let uu____10154 = get_exported_id_set env1 curmod
                             in
                          let uu____10201 =
...
let (push_module_abbrev :
  ...
  fun env  ->
    fun x  ->
      fun l  ->
        let uu____11014 = module_is_defined env l  in
        if uu____11014
        then
                ...
                fun se  ->
                  ...
                  | FStar_Syntax_Syntax.Sig_declare_typ (l,u,t) when
                      ...
                      let uu____11080 =
                        ...
                        FStar_Util.smap_try_find (sigmap env) uu____11088  in
                           ...
                           ((let uu____11168 =
                            ...
                            (let quals = FStar_Syntax_Syntax.Assumption ::
                             ...
                             (let uu____11192 = FStar_Ident.string_of_lid l
                                 in
                              FStar_Util.smap_add (sigmap env) uu____11192
                     ...
                     FStar_All.pipe_right lbs
                       (FStar_List.iter
                          (fun lb  ->
                             ...
                             FStar_Util.smap_remove (sigmap env) uu____11402))
                   else ();
                   if
                     (FStar_List.contains FStar_Syntax_Syntax.Abstract quals)
                       &&
                       ...
                       (FStar_List.iter
                          (fun lb  ->
                             ...
                             let uu____11435 = FStar_Ident.string_of_lid lid
                                in
                             FStar_Util.smap_add (sigmap env) uu____11435
                               (decl, false)))
                   else ())
              | uu____11446 -> ()));
      (let curmod =
         let uu____11449 = current_module env  in
         FStar_Ident.string_of_lid uu____11449  in
       (let uu____11451 =
          let uu____11548 = get_exported_id_set env curmod  in
          let uu____11595 = get_trans_exported_id_set env curmod  in
  ...
  fun env  ->
    FStar_Util.atomically
      (fun uu____12297  ->
         push_record_cache ();
         (let uu____12300 =
            let uu____12303 = FStar_ST.op_Bang stack  in env :: uu____12303
             in
          FStar_ST.op_Colon_Equals stack uu____12300);
         (let uu___1369_12352 = env  in
          let uu____12353 = FStar_Util.smap_copy env.exported_ids  in
          let uu____12358 = FStar_Util.smap_copy env.trans_exported_ids  in
          let uu____12363 = FStar_Util.smap_copy env.includes  in
          let uu____12374 = FStar_Util.smap_copy env.sigmap  in
          {
...
let (finish_module_or_interface :
  ...
  fun env  ->
    fun modul  ->
      ...
      let uu____12619 = finish env modul1  in (uu____12619, modul1)
...
let as_includes :
  'Auu____12977 .
    'Auu____12977 Prims.list FStar_Pervasives_Native.option ->
      'Auu____12977 Prims.list FStar_ST.ref
  =
  fun uu___31_12990  ->
...
let (inclusion_info : env -> FStar_Ident.lident -> module_inclusion_info) =
  fun env  ->
    fun l  ->
      ...
      let uu____13039 = as_ids_opt env.exported_ids  in
      let uu____13042 = as_ids_opt env.trans_exported_ids  in
      let uu____13045 =
        let uu____13050 = FStar_Util.smap_try_find env.includes mname  in
          ...
          fun mii  ->
            let prep env1 =
              ...
              (let uu____13243 = FStar_Ident.string_of_lid mname  in
               ...
               FStar_Util.smap_add env1.exported_ids uu____13243 uu____13245);
              (match () with
               | () ->
                   ((let uu____13250 = FStar_Ident.string_of_lid mname  in
                     let uu____13252 =
                       as_exported_id_set mii.mii_trans_exported_ids  in
                     FStar_Util.smap_add env1.trans_exported_ids uu____13250
                       uu____13252);
                    (match () with
                     | () ->
                         ((let uu____13257 = FStar_Ident.string_of_lid mname
                           ...
                           FStar_Util.smap_add env1.includes uu____13257
                             uu____13259);
                          (match () with
                           | () ->
                               let env' =
                                 let uu___1474_13269 = env1  in
                                 let uu____13270 =
                                   FStar_List.map
            ...
            | FStar_Pervasives_Native.None  ->
                let uu____13325 = prep env  in (uu____13325, false)
            | FStar_Pervasives_Native.Some (uu____13328,m) ->
                ((let uu____13335 =
                 ...
                 (let uu____13357 =
                    let uu____13358 = push env  in prep uu____13358  in
                  (uu____13357, true)))
...
let fail_or :
  ...
  fun env  ->
    fun lookup1  ->
      fun lid  ->
        let uu____13428 = lookup1 lid  in
            ...
            let msg1 =
              ...
              then msg
                ...
                (let modul =
                 ...
                 let uu____13475 = resolve_module_name env modul true  in
...
let fail_or2 :
  ...
  fun lookup1  ->
    fun id1  ->
      let uu____13542 = lookup1 id1  in
      match uu____13542 with
      | FStar_Pervasives_Native.None  ->
          let uu____13545 =
            let uu____13551 =
              let uu____13553 =
                let uu____13555 = FStar_Ident.text_of_id id1  in
          ...
          let uu____13560 = FStar_Ident.range_of_id id1  in
