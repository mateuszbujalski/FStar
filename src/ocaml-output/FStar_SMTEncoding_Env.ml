...
let (varops : varops_t) =
      ...
      let uu____1665 =
        ...
        FStar_Util.find_map uu____1669
          (fun uu____1735  ->
             ...
             | (names1,uu____1749) -> FStar_Util.smap_try_find names1 y1)
         in
  ...
  let new_fvar lid =
    let uu____1919 = FStar_Ident.string_of_lid lid  in mk_unique uu____1919
     in
  let next_id1 uu____1927 = FStar_Util.incr ctr; FStar_ST.op_Bang ctr  in
  let fresh1 mname pfx =
    let uu____1966 =
      let uu____1968 = next_id1 ()  in
  ...
  let string_const s =
    ...
    | FStar_Pervasives_Native.None  ->
        let id1 = next_id1 ()  in
        let f =
          let uu____2104 = FStar_SMTEncoding_Util.mk_String_const id1  in
  ...
  let snapshot1 uu____2459 = FStar_Common.snapshot push1 scopes ()  in
...
let binder_of_eithervar :
  'Auu____2748 'Auu____2749 .
    'Auu____2748 ->
      ('Auu____2748 * 'Auu____2749 FStar_Pervasives_Native.option)
...
let add_bvar_binding :
  'Auu____3574 .
    (FStar_Syntax_Syntax.bv * 'Auu____3574) ->
      (FStar_Syntax_Syntax.bv * 'Auu____3574) FStar_Util.pimap
        FStar_Util.psmap ->
        (FStar_Syntax_Syntax.bv * 'Auu____3574) FStar_Util.pimap
          FStar_Util.psmap
  =
                       ...
                       (match t.FStar_SMTEncoding_Term.tm with
                        | FStar_SMTEncoding_Term.App (uu____4471,fuel::[]) ->
                            ...
                            then
                              ...
                              FStar_All.pipe_left
                                (fun _4491  ->
                                   FStar_Pervasives_Native.Some _4491)
                                uu____4485
