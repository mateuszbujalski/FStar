          ...
          fun bs  ->
            ...
            let fail1 uu____1773 =
              let uu____1774 =
                ...
                FStar_Util.format5
                  ...
                  reason uu____1776
                  (if should_check1 then "true" else "false") uu____1778
                  uu____1780
                 in
            ...
            then ()
              ...
              (let uu____1793 =
               ...
               | (FStar_Pervasives_Native.Some
                  (uu____1895,hd1,gamma_tail),uu____1898::uu____1899) ->
    ...
    fun tm  ->
      ...
      let is_applied bs t =
        ...
        (let uu____3446 = FStar_Syntax_Util.head_and_args' t  in
         ...
         | (hd1,args) ->
             let uu____3485 =
               let uu____3486 = FStar_Syntax_Subst.compress hd1  in
                  ...
                  (if debug
                   then
                     (let uu____3494 = FStar_Syntax_Print.term_to_string t
                      ...
                      let uu____3498 = FStar_Syntax_Print.term_to_string hd1
                         in
                      FStar_Util.print3
                        "WPE> got it\n>>>>top = %s\n>>>>b = %s\n>>>>hd = %s\n"
