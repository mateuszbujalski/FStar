  ...
  fun cfg  ->
    fun fv  ->
      fun v1  ->
        ...
        FStar_Util.smap_add cfg.fv_cache uu____619 v1
    ...
    fun fvar1  ->
      FStar_Util.find_map lbs
        (fun lb  ->
           ...
           | FStar_Util.Inr name ->
               let uu____1990 = FStar_Syntax_Syntax.fv_eq name fvar1  in
               if uu____1990
      ...
      fun e  ->
        ...
        (let uu____2269 =
         ...
         | FStar_Syntax_Syntax.Tm_arrow (xs,c) ->
             let norm1 uu____2394 =
               ...
               | (ctx,binders_rev) ->
                ...
                in
             let uu____2617 =
               let uu____2634 = FStar_Thunk.mk norm1  in
         ...
         | FStar_Syntax_Syntax.Tm_fvar fvar1 ->
             let uu____2943 = try_in_cache cfg fvar1  in
             (match uu____2943 with
              | FStar_Pervasives_Native.Some t -> t
              | uu____2947 -> translate_fv cfg bs fvar1)
         ...
         | FStar_Syntax_Syntax.Tm_app (head1,args) ->
             (debug1
                (fun uu____3389  ->
                   let uu____3390 = FStar_Syntax_Print.term_to_string head1
                      in
                   let uu____3392 = FStar_Syntax_Print.args_to_string args
                      in
                   FStar_Util.print2 "Application: %s @ %s\n" uu____3390
                     uu____3392);
              (let uu____3395 = translate cfg bs head1  in
               let uu____3396 =
                 FStar_List.map
                   (fun x  ->
                      let uu____3418 =
                     ...
                     | FStar_Pervasives_Native.Some (branch1,args1) ->
                         let uu____4012 =
                           FStar_List.fold_left
                            ...
                            in
                         translate cfg uu____4012 branch1
                     | FStar_Pervasives_Native.None  ->
                   ...
                   (debug1
                    ...
                    (let uu____4039 = pickBranch cfg scrut2 branches  in
                     ...
                     | FStar_Pervasives_Native.None  ->
                         FStar_TypeChecker_NBETerm.mkAccuMatch scrut2
                           make_branches
                     | FStar_Pervasives_Native.Some (uu____4073,hd1::tl1) ->
                         failwith
        ...
        | FStar_TypeChecker_NBETerm.Lam (f1,binders,n1) ->
            ...
            then
              ...
              then
                ...
                (let uu____4927 = FStar_List.splitAt n1 args  in
    ...
    fun bs  ->
      fun fvar1  ->
        ...
        let qninfo =
          ...
          let uu____6028 = FStar_Syntax_Syntax.lid_of_fv fvar1  in
          FStar_TypeChecker_Env.lookup_qname uu____6027 uu____6028  in
        let uu____6029 = (is_constr qninfo) || (is_constr_fv fvar1)  in
        if uu____6029
        then FStar_TypeChecker_NBETerm.mkConstruct fvar1 [] []
          ...
          (let uu____6038 =
           ...
           | FStar_TypeChecker_Normalize.Should_unfold_no  ->
               (debug1
                  (fun uu____6047  ->
                     let uu____6048 = FStar_Syntax_Print.fv_to_string fvar1
                        in
               ...
               | FStar_Syntax_Syntax.Tm_app (head1,args) ->
                   (debug cfg
                    ...
                    (let fallback1 uu____7443 = translate cfg bs e1  in
                     ...
                     let uu____7456 =
                       let uu____7457 = FStar_Syntax_Util.un_uinst head1  in
          ...
          | (msrc,mtgt,ty) ->
              ...
              then
                ...
                let ret1 =
                  ...
                  | FStar_Syntax_Syntax.Tm_uinst (ret1,uu____7820::[]) ->
                      FStar_Syntax_Syntax.mk
                ...
                let t =
                  let uu____7831 =
                    let uu____7832 = translate cfg' [] ret1  in
                    iapp cfg' uu____7832
                      [((FStar_TypeChecker_NBETerm.Univ
                           FStar_Syntax_Syntax.U_unknown),
                         FStar_Pervasives_Native.None)]
      ...
      (match x with
       ...
       | FStar_TypeChecker_NBETerm.Lazy (FStar_Util.Inl li,uu____9573) ->
           FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_lazy li)
             FStar_Pervasives_Native.None FStar_Range.dummyRange
       | FStar_TypeChecker_NBETerm.Lazy (uu____9590,thunk1) ->
           let uu____9612 = FStar_Thunk.force thunk1  in
