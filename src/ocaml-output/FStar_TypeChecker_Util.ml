    ...
    fun t  ->
      let rec descend env t1 =
        ...
        | FStar_Syntax_Syntax.Tm_refine
            ...
            -> aux env t2
        | FStar_Syntax_Syntax.Tm_app (head1,uu____18411) -> descend env head1
        | FStar_Syntax_Syntax.Tm_uinst (head1,uu____18437) ->
            descend env head1
        | FStar_Syntax_Syntax.Tm_fvar fv ->
                               ...
                               | (is,g) ->
                                   let uu____18634 =
                                     ...
                                     | FStar_Pervasives_Native.Some repr_ts
                                      ...
                                      in
                                   (uu____18634, g))
                          | uu____18742 -> fail1 signature)
                     | uu____18743 -> fail1 signature)
                  ...
                  (match uu____18837 with
                   | FStar_Syntax_Syntax.Tm_arrow (bs,uu____18842) ->
                       ...
                       (match bs1 with
                        ...
                        | uu____18887 -> fail1 sig_tm)
                   | uu____18888 -> fail1 sig_tm)
            ...
            let err n1 =
              let uu____20087 =
                let uu____20093 =
                  ...
                  let uu____20097 = FStar_Util.string_of_int n1  in
                  let uu____20099 = FStar_Util.string_of_int index1  in
                  FStar_Util.format3
        ...
        let uu____20231 =
          let uu____20244 =
            FStar_All.pipe_right sub1.FStar_Syntax_Syntax.lift_wp
              FStar_Util.must
             in
          lift_tf_layered_effect sub1.FStar_Syntax_Syntax.target uu____20244
           in
        {
...
let (update_env_sub_eff :
  ...
  fun env  ->
    fun sub1  ->
      let uu____20678 = get_mlift_for_subeff env sub1  in
