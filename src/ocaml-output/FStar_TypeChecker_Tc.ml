          ...
          (match ses with
           | {
               FStar_Syntax_Syntax.sigel =
                 ...
                 (lex_t1,uu____255,[],t,uu____257,uu____258);
               ...
               FStar_Syntax_Syntax.sigopts = uu____262;_}::{
                                                             FStar_Syntax_Syntax.sigel
                                                               ...
                                                               (lex_top1,uu____264,_t_top,_lex_t_top,_302,uu____267);
                                                               ...
                                                               = uu____271;_}::
               {
                 FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon
                   (lex_cons,uu____273,_t_cons,_lex_t_cons,_312,uu____276);
               ...
               when
               ((_302 = Prims.int_zero) && (_312 = Prims.int_zero)) &&
               ...
               let lex_cons_t =
                 ...
                 FStar_Syntax_Util.arrow
                   ...
                   (tl1, FStar_Pervasives_Native.None)] uu____422
                  in
               let lex_cons_t1 =
              ...
              (fun uu___203_987  ->
                 ...
                 | () ->
                     let uu____994 = tc_inductive' env1 ses quals attrs lids
                        in
                     FStar_All.pipe_right uu____994 (fun r  -> pop1 (); r))
                ()
            with | uu___202_1025 -> (pop1 (); FStar_Exn.raise uu___202_1025)
                   ...
                   (FStar_List.iter
                      (fun lb  ->
                         ...
                         let has_iface_val =
                           ...
                           FStar_All.pipe_right iface_decls1 uu____1091  in
                         if has_iface_val
                         then
                           let must_erase =
    ...
    fun kont  ->
      ...
      | FStar_Pervasives_Native.Some ((a,FStar_Pervasives_Native.None )::[])
          ...
          FStar_Options.with_saved_options
            (fun uu____1282  ->
               (let uu____1284 =
                  let uu____1285 = unembed_optionstate a  in
                   ...
                   | {
                       ...
                       let rec rename_binders1 def_bs1 val_bs1 =
                         ...
                         | ((body_bv,uu____3124)::bt,(val_bv,aqual)::vt) ->
                             ...
                             let uu____3239 = rename_binders1 bt vt  in
                             uu____3181 :: uu____3239
                          in
                       let uu____3254 =
                         let uu____3261 =
                           let uu____3262 =
                             let uu____3277 = rename_binders1 def_bs val_bs
                                in
                             (uu____3277, c)  in
                                    ...
                                    (let uu____4200 =
                                     ...
                                     | (se4,lbs1) ->
                                         (FStar_All.pipe_right
                                          ...
                                          ([se4], [], env0))))))))
           | FStar_Syntax_Syntax.Sig_polymonadic_bind (m,n1,p,t,uu____4461)
               ->
               let t1 =
                 let uu____4463 =
                   (FStar_Options.use_two_phase_tc ()) &&
            ...
            ((let uu____5972 = FStar_Options.profile_group_by_decls ()  in
              ...
              then
                let tag =
                  ...
                  | hd1::uu____5979 -> FStar_Ident.string_of_lid hd1
                  | uu____5982 ->
    ...
    fun modul  ->
      fun exports  ->
        ...
        let check_term lid univs1 t =
          let uu____6171 = FStar_Syntax_Subst.open_univ_vars univs1 t  in
          ...
          | (univs2,t1) ->
              ((let uu____6179 =
               ...
               (let env2 = FStar_TypeChecker_Env.push_univ_vars env1 univs2
                ...
                FStar_All.pipe_right uu____6218 (fun a1  -> ())))
           in
          ...
          (let uu____6244 =
             let uu____6246 =
               FStar_Syntax_Print.lid_to_string
                 modul.FStar_Syntax_Syntax.name
                in
             let uu____6248 = FStar_Syntax_Print.lid_to_string lid  in
             FStar_Util.format2
               "Interface of %s violates its abstraction (add a 'private' qualifier to '%s'?)"
               uu____6246 uu____6248
              in
           FStar_Errors.message_prefix.FStar_Errors.set_prefix uu____6244);
          check_term lid univs1 t;
          FStar_Errors.message_prefix.FStar_Errors.clear_prefix ()  in
        let rec check_sigelt se =
          match se.FStar_Syntax_Syntax.sigel with
          | FStar_Syntax_Syntax.Sig_bundle (ses,uu____6259) ->
              let uu____6268 =
                let uu____6270 =
                  FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                    (FStar_List.contains FStar_Syntax_Syntax.Private)
                   in
                Prims.op_Negation uu____6270  in
              if uu____6268
              then FStar_All.pipe_right ses (FStar_List.iter check_sigelt)
              else ()
          | FStar_Syntax_Syntax.Sig_inductive_typ
              (l,univs1,binders,typ,uu____6284,uu____6285) ->
              let t =
                let uu____6297 =
                  let uu____6304 =
                    let uu____6305 =
                      let uu____6320 = FStar_Syntax_Syntax.mk_Total typ  in
                      (binders, uu____6320)  in
                    FStar_Syntax_Syntax.Tm_arrow uu____6305  in
                  FStar_Syntax_Syntax.mk uu____6304  in
                uu____6297 FStar_Pervasives_Native.None
                  se.FStar_Syntax_Syntax.sigrng
                 in
              check_term1 l univs1 t
          | FStar_Syntax_Syntax.Sig_datacon
              (l,univs1,t,uu____6336,uu____6337,uu____6338) ->
              check_term1 l univs1 t
              ...
              let uu____6348 =
                let uu____6350 =
                  FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                    (FStar_List.contains FStar_Syntax_Syntax.Private)
                   in
                Prims.op_Negation uu____6350  in
              if uu____6348 then check_term1 l univs1 t else ()
          | FStar_Syntax_Syntax.Sig_let ((uu____6358,lbs),uu____6360) ->
              let uu____6371 =
                let uu____6373 =
                  FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                    (FStar_List.contains FStar_Syntax_Syntax.Private)
                   in
                Prims.op_Negation uu____6373  in
              if uu____6371
              then
              ...
              let uu____6396 =
                let uu____6398 =
                  FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                    (FStar_List.contains FStar_Syntax_Syntax.Private)
                   in
                Prims.op_Negation uu____6398  in
              if uu____6396
              then
                let arrow1 =
                  FStar_Syntax_Syntax.mk
          ...
          | FStar_Syntax_Syntax.Sig_main uu____6419 -> ()
          | FStar_Syntax_Syntax.Sig_assume uu____6420 -> ()
          | FStar_Syntax_Syntax.Sig_new_effect uu____6427 -> ()
          | FStar_Syntax_Syntax.Sig_sub_effect uu____6428 -> ()
          | FStar_Syntax_Syntax.Sig_pragma uu____6429 -> ()
          | FStar_Syntax_Syntax.Sig_polymonadic_bind uu____6430 -> ()
          | FStar_Syntax_Syntax.Sig_fail uu____6441 ->
              failwith "Impossible (Already handled)"
          | FStar_Syntax_Syntax.Sig_splice uu____6455 ->
              failwith "Impossible (Already handled)"
           in
        let uu____6463 =
          FStar_Ident.lid_equals modul.FStar_Syntax_Syntax.name
            FStar_Parser_Const.prims_lid
           in
        if uu____6463 then () else FStar_List.iter check_sigelt exports
    ...
    fun m  ->
      ...
      let is_projector_or_discriminator_of_an_abstract_inductive quals =
        FStar_List.existsML
          (fun q  ->
             ...
             | FStar_Syntax_Syntax.Projector (l,uu____6569) -> true
             | uu____6571 -> false) quals
         in
              ...
              (match t.FStar_Syntax_Syntax.n with
               ...
               | uu____6640 ->
                   let uu____6641 =
                     let uu____6648 =
                       let uu____6649 =
                         let uu____6664 = FStar_Syntax_Syntax.mk_Total t  in
                         (bs, uu____6664)  in
                       FStar_Syntax_Syntax.Tm_arrow uu____6649  in
                     FStar_Syntax_Syntax.mk uu____6648  in
                   uu____6641 FStar_Pervasives_Native.None r)
           in
        match s.FStar_Syntax_Syntax.sigel with
        | FStar_Syntax_Syntax.Sig_inductive_typ
            (lid,uvs,bs,t,uu____6681,uu____6682) ->
            let s1 =
              let uu___1188_6692 = s  in
              let uu____6693 =
                let uu____6694 =
                  let uu____6701 =
                    mk_typ_for_abstract_inductive bs t
                     ...
                     in
                  (lid, uvs, uu____6701)  in
                FStar_Syntax_Syntax.Sig_declare_typ uu____6694  in
              let uu____6702 =
                let uu____6705 =
                  let uu____6708 =
                    filter_out_abstract_and_noeq
                     ...
                     in
                  FStar_Syntax_Syntax.New :: uu____6708  in
                FStar_Syntax_Syntax.Assumption :: uu____6705  in
              {
                FStar_Syntax_Syntax.sigel = uu____6693;
                FStar_Syntax_Syntax.sigrng =
                  (uu___1188_6692.FStar_Syntax_Syntax.sigrng);
                FStar_Syntax_Syntax.sigquals = uu____6702;
                FStar_Syntax_Syntax.sigmeta =
                  (uu___1188_6692.FStar_Syntax_Syntax.sigmeta);
                FStar_Syntax_Syntax.sigattrs =
                  (uu___1188_6692.FStar_Syntax_Syntax.sigattrs);
                FStar_Syntax_Syntax.sigopts =
                  (uu___1188_6692.FStar_Syntax_Syntax.sigopts)
              }  in
            [s1]
        | uu____6711 -> failwith "Impossible!"  in
      let val_of_lb s lid uu____6736 lbdef =
              ...
              then
                let uu____6752 =
                  ...
                  FStar_All.pipe_right uu____6753
                   ...
                   in
                uu____6752 :: (s.FStar_Syntax_Syntax.sigattrs)
              else s.FStar_Syntax_Syntax.sigattrs  in
            let uu___1201_6756 = s  in
            let uu____6757 =
              let uu____6760 =
                filter_out_abstract_and_inline s.FStar_Syntax_Syntax.sigquals
                 in
              FStar_Syntax_Syntax.Assumption :: uu____6760  in
            {
              FStar_Syntax_Syntax.sigel =
                (FStar_Syntax_Syntax.Sig_declare_typ (lid, uvs, t));
              FStar_Syntax_Syntax.sigrng =
                (uu___1201_6756.FStar_Syntax_Syntax.sigrng);
              FStar_Syntax_Syntax.sigquals = uu____6757;
              FStar_Syntax_Syntax.sigmeta =
                (uu___1201_6756.FStar_Syntax_Syntax.sigmeta);
              FStar_Syntax_Syntax.sigattrs = attrs;
              FStar_Syntax_Syntax.sigopts =
                (uu___1201_6756.FStar_Syntax_Syntax.sigopts)
            }
         in
      let should_keep_lbdef t =
        let comp_effect_name1 c =
          ...
          | uu____6778 -> failwith "Impossible!"  in
        let c_opt =
          let uu____6785 = FStar_Syntax_Util.is_unit t  in
          if uu____6785
          then
            let uu____6792 = FStar_Syntax_Syntax.mk_Total t  in
            FStar_Pervasives_Native.Some uu____6792
          else
            (let uu____6799 =
               let uu____6800 = FStar_Syntax_Subst.compress t  in
               uu____6800.FStar_Syntax_Syntax.n  in
             match uu____6799 with
             | FStar_Syntax_Syntax.Tm_arrow (uu____6807,c) ->
        ...
        | FStar_Pervasives_Native.Some c ->
            let uu____6843 = FStar_Syntax_Util.is_lemma_comp c  in
            if uu____6843
            then false
            else
              (let uu____6850 = FStar_Syntax_Util.is_pure_or_ghost_comp c  in
               if uu____6850
               then true
               else
                 (let uu____6857 = comp_effect_name1 c  in
                  FStar_TypeChecker_Env.is_reifiable_effect en uu____6857))
         in
      let extract_sigelt s =
        (let uu____6869 =
         ...
         if uu____6869
         then
           let uu____6872 = FStar_Syntax_Print.sigelt_to_string s  in
           FStar_Util.print1 "Extracting interface for %s\n" uu____6872
         else ());
        (match s.FStar_Syntax_Syntax.sigel with
         | FStar_Syntax_Syntax.Sig_inductive_typ uu____6879 ->
             failwith "Impossible! extract_interface: bare data constructor"
         | FStar_Syntax_Syntax.Sig_datacon uu____6899 ->
             failwith "Impossible! extract_interface: bare data constructor"
         | FStar_Syntax_Syntax.Sig_splice uu____6918 ->
             failwith
               "Impossible! extract_interface: trying to extract splice"
         | FStar_Syntax_Syntax.Sig_fail uu____6928 ->
             failwith
                 ...
                 (FStar_List.fold_left
                    (fun sigelts1  ->
                       fun s1  ->
                         ...
                         | FStar_Syntax_Syntax.Sig_inductive_typ
                             (lid,uu____6980,uu____6981,uu____6982,uu____6983,uu____6984)
                             ->
                             ((let uu____6994 =
                                 let uu____6997 =
                               ...
                               FStar_ST.op_Colon_Equals
                                 abstract_inductive_tycons uu____6994);
                              (let uu____7046 = vals_of_abstract_inductive s1
                                  in
                               FStar_List.append uu____7046 sigelts1))
                         | FStar_Syntax_Syntax.Sig_datacon
                             (lid,uu____7050,uu____7051,uu____7052,uu____7053,uu____7054)
                             ->
                             ((let uu____7062 =
                                 let uu____7065 =
                                   FStar_ST.op_Bang
                                 ...
                                 lid :: uu____7065  in
                               FStar_ST.op_Colon_Equals
                                 abstract_inductive_datacons uu____7062);
                              sigelts1)
                         | uu____7114 ->
                             failwith
         ...
         | FStar_Syntax_Syntax.Sig_declare_typ (lid,uvs,t) ->
             ...
             then []
               ...
               then
                 (let uu____7133 =
                    let uu___1267_7134 = s  in
                    let uu____7135 =
                      filter_out_abstract s.FStar_Syntax_Syntax.sigquals  in
                    {
                      FStar_Syntax_Syntax.sigel =
                        (uu___1267_7134.FStar_Syntax_Syntax.sigel);
                      FStar_Syntax_Syntax.sigrng =
                        (uu___1267_7134.FStar_Syntax_Syntax.sigrng);
                      FStar_Syntax_Syntax.sigquals = uu____7135;
                      FStar_Syntax_Syntax.sigmeta =
                        (uu___1267_7134.FStar_Syntax_Syntax.sigmeta);
                      FStar_Syntax_Syntax.sigattrs =
                        (uu___1267_7134.FStar_Syntax_Syntax.sigattrs);
                      FStar_Syntax_Syntax.sigopts =
                        (uu___1267_7134.FStar_Syntax_Syntax.sigopts)
                    }  in
                  [uu____7133])
               else []
         | FStar_Syntax_Syntax.Sig_let (lbs,lids) ->
         ...
         | FStar_Syntax_Syntax.Sig_assume (lid,uu____7291,uu____7292) ->
             let is_haseq = FStar_TypeChecker_TcInductive.is_haseq_lid lid
                in
             if is_haseq
             then
               let is_haseq_of_abstract_inductive =
                 let uu____7300 = FStar_ST.op_Bang abstract_inductive_tycons
                    in
                 FStar_List.existsML
                   (fun l  ->
                      let uu____7329 =
                        FStar_TypeChecker_TcInductive.get_haseq_axiom_lid l
                         in
                      FStar_Ident.lid_equals lid uu____7329) uu____7300
                  in
               (if is_haseq_of_abstract_inductive
                then
                  let uu____7333 =
                    let uu___1309_7334 = s  in
                    let uu____7335 =
                      filter_out_abstract s.FStar_Syntax_Syntax.sigquals  in
                    {
                      FStar_Syntax_Syntax.sigel =
                        (uu___1309_7334.FStar_Syntax_Syntax.sigel);
                      FStar_Syntax_Syntax.sigrng =
                        (uu___1309_7334.FStar_Syntax_Syntax.sigrng);
                      FStar_Syntax_Syntax.sigquals = uu____7335;
                      FStar_Syntax_Syntax.sigmeta =
                        (uu___1309_7334.FStar_Syntax_Syntax.sigmeta);
                      FStar_Syntax_Syntax.sigattrs =
                        (uu___1309_7334.FStar_Syntax_Syntax.sigattrs);
                      FStar_Syntax_Syntax.sigopts =
                        (uu___1309_7334.FStar_Syntax_Syntax.sigopts)
                    }  in
                  [uu____7333]
                else [])
             else
               (let uu____7342 =
                  let uu___1311_7343 = s  in
                  let uu____7344 =
                    filter_out_abstract s.FStar_Syntax_Syntax.sigquals  in
                  {
                    FStar_Syntax_Syntax.sigel =
                      (uu___1311_7343.FStar_Syntax_Syntax.sigel);
                    FStar_Syntax_Syntax.sigrng =
                      (uu___1311_7343.FStar_Syntax_Syntax.sigrng);
                    FStar_Syntax_Syntax.sigquals = uu____7344;
                    FStar_Syntax_Syntax.sigmeta =
                      (uu___1311_7343.FStar_Syntax_Syntax.sigmeta);
                    FStar_Syntax_Syntax.sigattrs =
                      (uu___1311_7343.FStar_Syntax_Syntax.sigattrs);
                    FStar_Syntax_Syntax.sigopts =
                      (uu___1311_7343.FStar_Syntax_Syntax.sigopts)
                  }  in
                [uu____7342])
         | FStar_Syntax_Syntax.Sig_new_effect uu____7347 -> [s]
         | FStar_Syntax_Syntax.Sig_sub_effect uu____7348 -> [s]
         | FStar_Syntax_Syntax.Sig_effect_abbrev uu____7349 -> [s]
         | FStar_Syntax_Syntax.Sig_pragma uu____7362 -> [s]
         | FStar_Syntax_Syntax.Sig_polymonadic_bind uu____7363 -> [s])
         in
      let uu___1323_7374 = m  in
      let uu____7375 =
        let uu____7376 =
          FStar_All.pipe_right m.FStar_Syntax_Syntax.declarations
            (FStar_List.map extract_sigelt)
           in
        FStar_All.pipe_right uu____7376 FStar_List.flatten  in
      {
        FStar_Syntax_Syntax.name = (uu___1323_7374.FStar_Syntax_Syntax.name);
        FStar_Syntax_Syntax.declarations = uu____7375;
        FStar_Syntax_Syntax.exports =
          (uu___1323_7374.FStar_Syntax_Syntax.exports);
  ...
  fun env  ->
    fun msg  ->
      FStar_Util.atomically
        (fun uu____7427  -> FStar_TypeChecker_Env.snapshot env msg)
...
let (push_context :
  ...
  fun env  ->
    fun msg  ->
      let uu____7489 = snapshot_context env msg  in
      FStar_Pervasives_Native.snd uu____7489
  ...
  fun env  ->
    fun modul  ->
      let verify =
        ...
        FStar_Options.should_verify uu____7561  in
      let action = if verify then "Verifying" else "Lax-checking"  in
      let label1 =
        if modul.FStar_Syntax_Syntax.is_interface
        then "interface"
        else "implementation"  in
      (let uu____7580 = FStar_Options.debug_any ()  in
       if uu____7580
       then
         let uu____7583 =
           FStar_Ident.string_of_lid modul.FStar_Syntax_Syntax.name  in
         FStar_Util.print3 "%s %s of %s\n" action label1 uu____7583
       else ());
      (let name =
         let uu____7590 =
           FStar_Ident.string_of_lid modul.FStar_Syntax_Syntax.name  in
         FStar_Util.format2 "%s %s"
           (if modul.FStar_Syntax_Syntax.is_interface
            then "interface"
            else "module") uu____7590
          in
       let env1 =
         let uu___1348_7600 = env  in
         {
           FStar_TypeChecker_Env.solver =
             (uu___1348_7600.FStar_TypeChecker_Env.solver);
           FStar_TypeChecker_Env.range =
             (uu___1348_7600.FStar_TypeChecker_Env.range);
           FStar_TypeChecker_Env.curmodule =
             (uu___1348_7600.FStar_TypeChecker_Env.curmodule);
           FStar_TypeChecker_Env.gamma =
             (uu___1348_7600.FStar_TypeChecker_Env.gamma);
           FStar_TypeChecker_Env.gamma_sig =
             (uu___1348_7600.FStar_TypeChecker_Env.gamma_sig);
           FStar_TypeChecker_Env.gamma_cache =
             (uu___1348_7600.FStar_TypeChecker_Env.gamma_cache);
           FStar_TypeChecker_Env.modules =
             (uu___1348_7600.FStar_TypeChecker_Env.modules);
           FStar_TypeChecker_Env.expected_typ =
             (uu___1348_7600.FStar_TypeChecker_Env.expected_typ);
           FStar_TypeChecker_Env.sigtab =
             (uu___1348_7600.FStar_TypeChecker_Env.sigtab);
           FStar_TypeChecker_Env.attrtab =
             (uu___1348_7600.FStar_TypeChecker_Env.attrtab);
           FStar_TypeChecker_Env.instantiate_imp =
             (uu___1348_7600.FStar_TypeChecker_Env.instantiate_imp);
           FStar_TypeChecker_Env.effects =
             (uu___1348_7600.FStar_TypeChecker_Env.effects);
           FStar_TypeChecker_Env.generalize =
             (uu___1348_7600.FStar_TypeChecker_Env.generalize);
           FStar_TypeChecker_Env.letrecs =
             (uu___1348_7600.FStar_TypeChecker_Env.letrecs);
           FStar_TypeChecker_Env.top_level =
             (uu___1348_7600.FStar_TypeChecker_Env.top_level);
           FStar_TypeChecker_Env.check_uvars =
             (uu___1348_7600.FStar_TypeChecker_Env.check_uvars);
           FStar_TypeChecker_Env.use_eq =
             (uu___1348_7600.FStar_TypeChecker_Env.use_eq);
           FStar_TypeChecker_Env.use_eq_strict =
             (uu___1348_7600.FStar_TypeChecker_Env.use_eq_strict);
           FStar_TypeChecker_Env.is_iface =
             (modul.FStar_Syntax_Syntax.is_interface);
           FStar_TypeChecker_Env.admit = (Prims.op_Negation verify);
           FStar_TypeChecker_Env.lax =
             (uu___1348_7600.FStar_TypeChecker_Env.lax);
           FStar_TypeChecker_Env.lax_universes =
             (uu___1348_7600.FStar_TypeChecker_Env.lax_universes);
           FStar_TypeChecker_Env.phase1 =
             (uu___1348_7600.FStar_TypeChecker_Env.phase1);
           FStar_TypeChecker_Env.failhard =
             (uu___1348_7600.FStar_TypeChecker_Env.failhard);
           FStar_TypeChecker_Env.nosynth =
             (uu___1348_7600.FStar_TypeChecker_Env.nosynth);
           FStar_TypeChecker_Env.uvar_subtyping =
             (uu___1348_7600.FStar_TypeChecker_Env.uvar_subtyping);
           FStar_TypeChecker_Env.tc_term =
             (uu___1348_7600.FStar_TypeChecker_Env.tc_term);
           FStar_TypeChecker_Env.type_of =
             (uu___1348_7600.FStar_TypeChecker_Env.type_of);
           FStar_TypeChecker_Env.universe_of =
             (uu___1348_7600.FStar_TypeChecker_Env.universe_of);
           FStar_TypeChecker_Env.check_type_of =
             (uu___1348_7600.FStar_TypeChecker_Env.check_type_of);
           FStar_TypeChecker_Env.use_bv_sorts =
             (uu___1348_7600.FStar_TypeChecker_Env.use_bv_sorts);
           FStar_TypeChecker_Env.qtbl_name_and_index =
             (uu___1348_7600.FStar_TypeChecker_Env.qtbl_name_and_index);
           FStar_TypeChecker_Env.normalized_eff_names =
             (uu___1348_7600.FStar_TypeChecker_Env.normalized_eff_names);
           FStar_TypeChecker_Env.fv_delta_depths =
             (uu___1348_7600.FStar_TypeChecker_Env.fv_delta_depths);
           FStar_TypeChecker_Env.proof_ns =
             (uu___1348_7600.FStar_TypeChecker_Env.proof_ns);
           FStar_TypeChecker_Env.synth_hook =
             (uu___1348_7600.FStar_TypeChecker_Env.synth_hook);
           FStar_TypeChecker_Env.try_solve_implicits_hook =
             (uu___1348_7600.FStar_TypeChecker_Env.try_solve_implicits_hook);
           FStar_TypeChecker_Env.splice =
             (uu___1348_7600.FStar_TypeChecker_Env.splice);
           FStar_TypeChecker_Env.mpreprocess =
             (uu___1348_7600.FStar_TypeChecker_Env.mpreprocess);
           FStar_TypeChecker_Env.postprocess =
             (uu___1348_7600.FStar_TypeChecker_Env.postprocess);
           FStar_TypeChecker_Env.is_native_tactic =
             (uu___1348_7600.FStar_TypeChecker_Env.is_native_tactic);
           FStar_TypeChecker_Env.identifier_info =
             (uu___1348_7600.FStar_TypeChecker_Env.identifier_info);
           FStar_TypeChecker_Env.tc_hooks =
             (uu___1348_7600.FStar_TypeChecker_Env.tc_hooks);
           FStar_TypeChecker_Env.dsenv =
             (uu___1348_7600.FStar_TypeChecker_Env.dsenv);
           FStar_TypeChecker_Env.nbe =
             (uu___1348_7600.FStar_TypeChecker_Env.nbe);
           FStar_TypeChecker_Env.strict_args_tab =
             (uu___1348_7600.FStar_TypeChecker_Env.strict_args_tab);
           FStar_TypeChecker_Env.erasable_types_tab =
             (uu___1348_7600.FStar_TypeChecker_Env.erasable_types_tab)
         }  in
       let env2 =
         FStar_TypeChecker_Env.set_current_module env1
           modul.FStar_Syntax_Syntax.name
          in
       let uu____7602 = tc_decls env2 modul.FStar_Syntax_Syntax.declarations
          in
       match uu____7602 with
       | (ses,exports,env3) ->
           ((let uu___1356_7635 = modul  in
             {
               FStar_Syntax_Syntax.name =
                 (uu___1356_7635.FStar_Syntax_Syntax.name);
               FStar_Syntax_Syntax.declarations = ses;
               FStar_Syntax_Syntax.exports =
                 (uu___1356_7635.FStar_Syntax_Syntax.exports);
               FStar_Syntax_Syntax.is_interface =
                 (uu___1356_7635.FStar_Syntax_Syntax.is_interface)
             }), exports, env3))
...
let (tc_more_partial_modul :
  ...
  fun env  ->
    fun modul  ->
      fun decls  ->
        let uu____7664 = tc_decls env decls  in
        match uu____7664 with
        | (ses,exports,env1) ->
            let modul1 =
              let uu___1365_7695 = modul  in
              {
                FStar_Syntax_Syntax.name =
                  (uu___1365_7695.FStar_Syntax_Syntax.name);
                FStar_Syntax_Syntax.declarations =
                  (FStar_List.append modul.FStar_Syntax_Syntax.declarations
                     ses);
                FStar_Syntax_Syntax.exports =
                  (uu___1365_7695.FStar_Syntax_Syntax.exports);
                FStar_Syntax_Syntax.is_interface =
                  (uu___1365_7695.FStar_Syntax_Syntax.is_interface)
              }  in
            (modul1, exports, env1)
    ...
    fun m  ->
      fun iface_exists  ->
        let msg =
          ...
          Prims.op_Hat "Internals for " uu____7754  in
        let env01 = push_context env0 msg  in
        let uu____7758 = tc_partial_modul env01 m  in
          ...
          fun exports  ->
            let should_extract_interface =
              ((((Prims.op_Negation loading_from_cache) &&
                ...
                &&
                (let uu____7795 = FStar_Errors.get_err_count ()  in
                 uu____7795 = Prims.int_zero)
               in
              ...
              ((let uu____7806 =
                ...
                then
                    ...
                    let uu____7814 =
                      let uu____7816 =
                        FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name
                         in
                      FStar_Options.should_verify uu____7816  in
                    if uu____7814 then "" else " (in lax mode) "  in
                  let uu____7824 =
                    let uu____7826 =
                      let uu____7828 =
                        FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name
                         in
                      FStar_Options.dump_module uu____7828  in
                    if uu____7826
                    then
                      let uu____7832 =
                        let uu____7834 = FStar_Syntax_Print.modul_to_string m
                           in
                        Prims.op_Hat uu____7834 "\n"  in
                      Prims.op_Hat "\nfrom: " uu____7832
                    else ""  in
                  let uu____7841 =
                    let uu____7843 =
                      let uu____7845 =
                        FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name
                         in
                      FStar_Options.dump_module uu____7845  in
                    if uu____7843
                    then
                      let uu____7849 =
                        let uu____7851 =
                  ...
                  FStar_Util.print4
                    ...
                    uu____7810 uu____7812 uu____7824 uu____7841
                else ());
               (let en0 =
                  let en0 =
                    let uu____7863 =
                      let uu____7865 =
                        FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name
                         in
                      Prims.op_Hat "Ending modul " uu____7865  in
                    pop_context en uu____7863  in
                  let en01 =
                    let uu___1391_7869 = en0  in
                    {
                      FStar_TypeChecker_Env.solver =
                        (uu___1391_7869.FStar_TypeChecker_Env.solver);
                      FStar_TypeChecker_Env.range =
                        (uu___1391_7869.FStar_TypeChecker_Env.range);
                      FStar_TypeChecker_Env.curmodule =
                        (uu___1391_7869.FStar_TypeChecker_Env.curmodule);
                      FStar_TypeChecker_Env.gamma =
                        (uu___1391_7869.FStar_TypeChecker_Env.gamma);
                      FStar_TypeChecker_Env.gamma_sig =
                        (uu___1391_7869.FStar_TypeChecker_Env.gamma_sig);
                      FStar_TypeChecker_Env.gamma_cache =
                        (uu___1391_7869.FStar_TypeChecker_Env.gamma_cache);
                      FStar_TypeChecker_Env.modules =
                        (uu___1391_7869.FStar_TypeChecker_Env.modules);
                      FStar_TypeChecker_Env.expected_typ =
                        (uu___1391_7869.FStar_TypeChecker_Env.expected_typ);
                      FStar_TypeChecker_Env.sigtab =
                        (uu___1391_7869.FStar_TypeChecker_Env.sigtab);
                      FStar_TypeChecker_Env.attrtab =
                        (uu___1391_7869.FStar_TypeChecker_Env.attrtab);
                      FStar_TypeChecker_Env.instantiate_imp =
                        (uu___1391_7869.FStar_TypeChecker_Env.instantiate_imp);
                      FStar_TypeChecker_Env.effects =
                        (uu___1391_7869.FStar_TypeChecker_Env.effects);
                      FStar_TypeChecker_Env.generalize =
                        (uu___1391_7869.FStar_TypeChecker_Env.generalize);
                      FStar_TypeChecker_Env.letrecs =
                        (uu___1391_7869.FStar_TypeChecker_Env.letrecs);
                      FStar_TypeChecker_Env.top_level =
                        (uu___1391_7869.FStar_TypeChecker_Env.top_level);
                      FStar_TypeChecker_Env.check_uvars =
                        (uu___1391_7869.FStar_TypeChecker_Env.check_uvars);
                      FStar_TypeChecker_Env.use_eq =
                        (uu___1391_7869.FStar_TypeChecker_Env.use_eq);
                      FStar_TypeChecker_Env.use_eq_strict =
                        (uu___1391_7869.FStar_TypeChecker_Env.use_eq_strict);
                      FStar_TypeChecker_Env.is_iface =
                        (uu___1391_7869.FStar_TypeChecker_Env.is_iface);
                      FStar_TypeChecker_Env.admit =
                        (uu___1391_7869.FStar_TypeChecker_Env.admit);
                      FStar_TypeChecker_Env.lax =
                        (uu___1391_7869.FStar_TypeChecker_Env.lax);
                      FStar_TypeChecker_Env.lax_universes =
                        (uu___1391_7869.FStar_TypeChecker_Env.lax_universes);
                      FStar_TypeChecker_Env.phase1 =
                        (uu___1391_7869.FStar_TypeChecker_Env.phase1);
                      FStar_TypeChecker_Env.failhard =
                        (uu___1391_7869.FStar_TypeChecker_Env.failhard);
                      FStar_TypeChecker_Env.nosynth =
                        (uu___1391_7869.FStar_TypeChecker_Env.nosynth);
                      FStar_TypeChecker_Env.uvar_subtyping =
                        (uu___1391_7869.FStar_TypeChecker_Env.uvar_subtyping);
                      FStar_TypeChecker_Env.tc_term =
                        (uu___1391_7869.FStar_TypeChecker_Env.tc_term);
                      FStar_TypeChecker_Env.type_of =
                        (uu___1391_7869.FStar_TypeChecker_Env.type_of);
                      FStar_TypeChecker_Env.universe_of =
                        (uu___1391_7869.FStar_TypeChecker_Env.universe_of);
                      FStar_TypeChecker_Env.check_type_of =
                        (uu___1391_7869.FStar_TypeChecker_Env.check_type_of);
                      FStar_TypeChecker_Env.use_bv_sorts =
                        (uu___1391_7869.FStar_TypeChecker_Env.use_bv_sorts);
                      FStar_TypeChecker_Env.qtbl_name_and_index =
                        (uu___1391_7869.FStar_TypeChecker_Env.qtbl_name_and_index);
                      FStar_TypeChecker_Env.normalized_eff_names =
                        (uu___1391_7869.FStar_TypeChecker_Env.normalized_eff_names);
                      FStar_TypeChecker_Env.fv_delta_depths =
                        (uu___1391_7869.FStar_TypeChecker_Env.fv_delta_depths);
                      FStar_TypeChecker_Env.proof_ns =
                        (uu___1391_7869.FStar_TypeChecker_Env.proof_ns);
                      FStar_TypeChecker_Env.synth_hook =
                        (uu___1391_7869.FStar_TypeChecker_Env.synth_hook);
                      FStar_TypeChecker_Env.try_solve_implicits_hook =
                        (uu___1391_7869.FStar_TypeChecker_Env.try_solve_implicits_hook);
                      FStar_TypeChecker_Env.splice =
                        (uu___1391_7869.FStar_TypeChecker_Env.splice);
                      FStar_TypeChecker_Env.mpreprocess =
                        (uu___1391_7869.FStar_TypeChecker_Env.mpreprocess);
                      FStar_TypeChecker_Env.postprocess =
                        (uu___1391_7869.FStar_TypeChecker_Env.postprocess);
                      FStar_TypeChecker_Env.is_native_tactic =
                        (uu___1391_7869.FStar_TypeChecker_Env.is_native_tactic);
                      FStar_TypeChecker_Env.identifier_info =
                        (uu___1391_7869.FStar_TypeChecker_Env.identifier_info);
                      FStar_TypeChecker_Env.tc_hooks =
                        (uu___1391_7869.FStar_TypeChecker_Env.tc_hooks);
                      FStar_TypeChecker_Env.dsenv =
                        (en.FStar_TypeChecker_Env.dsenv);
                      FStar_TypeChecker_Env.nbe =
                        (uu___1391_7869.FStar_TypeChecker_Env.nbe);
                      FStar_TypeChecker_Env.strict_args_tab =
                        (uu___1391_7869.FStar_TypeChecker_Env.strict_args_tab);
                      FStar_TypeChecker_Env.erasable_types_tab =
                        (uu___1391_7869.FStar_TypeChecker_Env.erasable_types_tab)
                    }  in
                  let en02 =
                    let uu___1394_7871 = en01  in
                    let uu____7872 =
                      let uu____7887 =
                        FStar_All.pipe_right
                          ...
                          FStar_Pervasives_Native.fst
                         in
                      (uu____7887, FStar_Pervasives_Native.None)  in
                    {
                      FStar_TypeChecker_Env.solver =
                        (uu___1394_7871.FStar_TypeChecker_Env.solver);
                      FStar_TypeChecker_Env.range =
                        (uu___1394_7871.FStar_TypeChecker_Env.range);
                      FStar_TypeChecker_Env.curmodule =
                        (uu___1394_7871.FStar_TypeChecker_Env.curmodule);
                      FStar_TypeChecker_Env.gamma =
                        (uu___1394_7871.FStar_TypeChecker_Env.gamma);
                      FStar_TypeChecker_Env.gamma_sig =
                        (uu___1394_7871.FStar_TypeChecker_Env.gamma_sig);
                      FStar_TypeChecker_Env.gamma_cache =
                        (uu___1394_7871.FStar_TypeChecker_Env.gamma_cache);
                      FStar_TypeChecker_Env.modules =
                        (uu___1394_7871.FStar_TypeChecker_Env.modules);
                      FStar_TypeChecker_Env.expected_typ =
                        (uu___1394_7871.FStar_TypeChecker_Env.expected_typ);
                      FStar_TypeChecker_Env.sigtab =
                        (uu___1394_7871.FStar_TypeChecker_Env.sigtab);
                      FStar_TypeChecker_Env.attrtab =
                        (uu___1394_7871.FStar_TypeChecker_Env.attrtab);
                      FStar_TypeChecker_Env.instantiate_imp =
                        (uu___1394_7871.FStar_TypeChecker_Env.instantiate_imp);
                      FStar_TypeChecker_Env.effects =
                        (uu___1394_7871.FStar_TypeChecker_Env.effects);
                      FStar_TypeChecker_Env.generalize =
                        (uu___1394_7871.FStar_TypeChecker_Env.generalize);
                      FStar_TypeChecker_Env.letrecs =
                        (uu___1394_7871.FStar_TypeChecker_Env.letrecs);
                      FStar_TypeChecker_Env.top_level =
                        (uu___1394_7871.FStar_TypeChecker_Env.top_level);
                      FStar_TypeChecker_Env.check_uvars =
                        (uu___1394_7871.FStar_TypeChecker_Env.check_uvars);
                      FStar_TypeChecker_Env.use_eq =
                        (uu___1394_7871.FStar_TypeChecker_Env.use_eq);
                      FStar_TypeChecker_Env.use_eq_strict =
                        (uu___1394_7871.FStar_TypeChecker_Env.use_eq_strict);
                      FStar_TypeChecker_Env.is_iface =
                        (uu___1394_7871.FStar_TypeChecker_Env.is_iface);
                      FStar_TypeChecker_Env.admit =
                        (uu___1394_7871.FStar_TypeChecker_Env.admit);
                      FStar_TypeChecker_Env.lax =
                        (uu___1394_7871.FStar_TypeChecker_Env.lax);
                      FStar_TypeChecker_Env.lax_universes =
                        (uu___1394_7871.FStar_TypeChecker_Env.lax_universes);
                      FStar_TypeChecker_Env.phase1 =
                        (uu___1394_7871.FStar_TypeChecker_Env.phase1);
                      FStar_TypeChecker_Env.failhard =
                        (uu___1394_7871.FStar_TypeChecker_Env.failhard);
                      FStar_TypeChecker_Env.nosynth =
                        (uu___1394_7871.FStar_TypeChecker_Env.nosynth);
                      FStar_TypeChecker_Env.uvar_subtyping =
                        (uu___1394_7871.FStar_TypeChecker_Env.uvar_subtyping);
                      FStar_TypeChecker_Env.tc_term =
                        (uu___1394_7871.FStar_TypeChecker_Env.tc_term);
                      FStar_TypeChecker_Env.type_of =
                        (uu___1394_7871.FStar_TypeChecker_Env.type_of);
                      FStar_TypeChecker_Env.universe_of =
                        (uu___1394_7871.FStar_TypeChecker_Env.universe_of);
                      FStar_TypeChecker_Env.check_type_of =
                        (uu___1394_7871.FStar_TypeChecker_Env.check_type_of);
                      FStar_TypeChecker_Env.use_bv_sorts =
                        (uu___1394_7871.FStar_TypeChecker_Env.use_bv_sorts);
                      FStar_TypeChecker_Env.qtbl_name_and_index = uu____7872;
                      FStar_TypeChecker_Env.normalized_eff_names =
                        (uu___1394_7871.FStar_TypeChecker_Env.normalized_eff_names);
                      FStar_TypeChecker_Env.fv_delta_depths =
                        (uu___1394_7871.FStar_TypeChecker_Env.fv_delta_depths);
                      FStar_TypeChecker_Env.proof_ns =
                        (uu___1394_7871.FStar_TypeChecker_Env.proof_ns);
                      FStar_TypeChecker_Env.synth_hook =
                        (uu___1394_7871.FStar_TypeChecker_Env.synth_hook);
                      FStar_TypeChecker_Env.try_solve_implicits_hook =
                        (uu___1394_7871.FStar_TypeChecker_Env.try_solve_implicits_hook);
                      FStar_TypeChecker_Env.splice =
                        (uu___1394_7871.FStar_TypeChecker_Env.splice);
                      FStar_TypeChecker_Env.mpreprocess =
                        (uu___1394_7871.FStar_TypeChecker_Env.mpreprocess);
                      FStar_TypeChecker_Env.postprocess =
                        (uu___1394_7871.FStar_TypeChecker_Env.postprocess);
                      FStar_TypeChecker_Env.is_native_tactic =
                        (uu___1394_7871.FStar_TypeChecker_Env.is_native_tactic);
                      FStar_TypeChecker_Env.identifier_info =
                        (uu___1394_7871.FStar_TypeChecker_Env.identifier_info);
                      FStar_TypeChecker_Env.tc_hooks =
                        (uu___1394_7871.FStar_TypeChecker_Env.tc_hooks);
                      FStar_TypeChecker_Env.dsenv =
                        (uu___1394_7871.FStar_TypeChecker_Env.dsenv);
                      FStar_TypeChecker_Env.nbe =
                        (uu___1394_7871.FStar_TypeChecker_Env.nbe);
                      FStar_TypeChecker_Env.strict_args_tab =
                        (uu___1394_7871.FStar_TypeChecker_Env.strict_args_tab);
                      FStar_TypeChecker_Env.erasable_types_tab =
                        (uu___1394_7871.FStar_TypeChecker_Env.erasable_types_tab)
                    }  in
                  let uu____7933 =
                    let uu____7935 = FStar_Options.interactive ()  in
                    Prims.op_Negation uu____7935  in
                  if uu____7933
                  then
                    ((let uu____7939 =
                        FStar_Options.restore_cmd_line_options true  in
                      FStar_All.pipe_right uu____7939 (fun a2  -> ()));
                     en02)
                  else en02  in
                let uu____7943 = tc_modul en0 modul_iface true  in
                match uu____7943 with
                | (modul_iface1,env) ->
                    ((let uu___1403_7956 = m  in
                      {
                        FStar_Syntax_Syntax.name =
                          (uu___1403_7956.FStar_Syntax_Syntax.name);
                        FStar_Syntax_Syntax.declarations =
                          (uu___1403_7956.FStar_Syntax_Syntax.declarations);
                        FStar_Syntax_Syntax.exports =
                          (modul_iface1.FStar_Syntax_Syntax.exports);
                        FStar_Syntax_Syntax.is_interface =
                          (uu___1403_7956.FStar_Syntax_Syntax.is_interface)
                      }), env)))
            else
              (let modul =
                 let uu___1405_7960 = m  in
                 {
                   FStar_Syntax_Syntax.name =
                     (uu___1405_7960.FStar_Syntax_Syntax.name);
                   FStar_Syntax_Syntax.declarations =
                     (uu___1405_7960.FStar_Syntax_Syntax.declarations);
                   FStar_Syntax_Syntax.exports = exports;
                   FStar_Syntax_Syntax.is_interface =
                     (uu___1405_7960.FStar_Syntax_Syntax.is_interface)
                 }  in
               ...
               (let uu____7963 =
                  FStar_All.pipe_right
                    ...
                    FStar_Pervasives_Native.fst
                   in
                FStar_All.pipe_right uu____7963 FStar_Util.smap_clear);
               (let uu____7999 =
                  ((let uu____8003 = FStar_Options.lax ()  in
                    Prims.op_Negation uu____8003) &&
                     (Prims.op_Negation loading_from_cache))
                    &&
                    (let uu____8006 =
                       FStar_Options.use_extracted_interfaces ()  in
                     Prims.op_Negation uu____8006)
                   in
                if uu____7999 then check_exports env modul exports else ());
               (let uu____8012 =
                  let uu____8013 =
                    let uu____8015 =
                      FStar_Ident.string_of_lid
                        modul.FStar_Syntax_Syntax.name
                       in
                    Prims.op_Hat "Ending modul " uu____8015  in
                  pop_context env uu____8013  in
                FStar_All.pipe_right uu____8012 (fun a3  -> ()));
               (modul, env))
    ...
    fun m  ->
      ...
      let env1 =
        let uu____8031 =
          let uu____8033 =
            FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name  in
          Prims.op_Hat "Internals for " uu____8033  in
        push_context env uu____8031  in
      let env2 =
        FStar_List.fold_left
          (fun env2  ->
             fun se  ->
      ...
      let uu____8058 =
        finish_partial_modul true true env2 m m.FStar_Syntax_Syntax.exports
         in
      match uu____8058 with | (uu____8065,env3) -> env3
...
let (check_module :
  ...
  fun env  ->
    fun m  ->
      fun b  ->
        (let uu____8090 = FStar_Options.debug_any ()  in
         if uu____8090
         then
           let uu____8093 =
           ...
           FStar_Util.print2 "Checking %s: %s\n"
             (if m.FStar_Syntax_Syntax.is_interface
              then "i'face"
              else "module") uu____8093
         else ());
        (let uu____8105 =
           let uu____8107 =
             FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name  in
           FStar_Options.dump_module uu____8107  in
         if uu____8105
         then
           let uu____8110 = FStar_Syntax_Print.modul_to_string m  in
           FStar_Util.print1 "Module before type checking:\n%s\n" uu____8110
         else ());
        (let env1 =
           let uu___1435_8116 = env  in
           let uu____8117 =
             let uu____8119 =
               let uu____8121 =
                 FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name  in
               FStar_Options.should_verify uu____8121  in
             Prims.op_Negation uu____8119  in
           {
             FStar_TypeChecker_Env.solver =
               (uu___1435_8116.FStar_TypeChecker_Env.solver);
             FStar_TypeChecker_Env.range =
               (uu___1435_8116.FStar_TypeChecker_Env.range);
             FStar_TypeChecker_Env.curmodule =
               (uu___1435_8116.FStar_TypeChecker_Env.curmodule);
             FStar_TypeChecker_Env.gamma =
               (uu___1435_8116.FStar_TypeChecker_Env.gamma);
             FStar_TypeChecker_Env.gamma_sig =
               (uu___1435_8116.FStar_TypeChecker_Env.gamma_sig);
             FStar_TypeChecker_Env.gamma_cache =
               (uu___1435_8116.FStar_TypeChecker_Env.gamma_cache);
             FStar_TypeChecker_Env.modules =
               (uu___1435_8116.FStar_TypeChecker_Env.modules);
             FStar_TypeChecker_Env.expected_typ =
               (uu___1435_8116.FStar_TypeChecker_Env.expected_typ);
             FStar_TypeChecker_Env.sigtab =
               (uu___1435_8116.FStar_TypeChecker_Env.sigtab);
             FStar_TypeChecker_Env.attrtab =
               (uu___1435_8116.FStar_TypeChecker_Env.attrtab);
             FStar_TypeChecker_Env.instantiate_imp =
               (uu___1435_8116.FStar_TypeChecker_Env.instantiate_imp);
             FStar_TypeChecker_Env.effects =
               (uu___1435_8116.FStar_TypeChecker_Env.effects);
             FStar_TypeChecker_Env.generalize =
               (uu___1435_8116.FStar_TypeChecker_Env.generalize);
             FStar_TypeChecker_Env.letrecs =
               (uu___1435_8116.FStar_TypeChecker_Env.letrecs);
             FStar_TypeChecker_Env.top_level =
               (uu___1435_8116.FStar_TypeChecker_Env.top_level);
             FStar_TypeChecker_Env.check_uvars =
               (uu___1435_8116.FStar_TypeChecker_Env.check_uvars);
             FStar_TypeChecker_Env.use_eq =
               (uu___1435_8116.FStar_TypeChecker_Env.use_eq);
             FStar_TypeChecker_Env.use_eq_strict =
               (uu___1435_8116.FStar_TypeChecker_Env.use_eq_strict);
             FStar_TypeChecker_Env.is_iface =
               (uu___1435_8116.FStar_TypeChecker_Env.is_iface);
             FStar_TypeChecker_Env.admit =
               (uu___1435_8116.FStar_TypeChecker_Env.admit);
             FStar_TypeChecker_Env.lax = uu____8117;
             FStar_TypeChecker_Env.lax_universes =
               (uu___1435_8116.FStar_TypeChecker_Env.lax_universes);
             FStar_TypeChecker_Env.phase1 =
               (uu___1435_8116.FStar_TypeChecker_Env.phase1);
             FStar_TypeChecker_Env.failhard =
               (uu___1435_8116.FStar_TypeChecker_Env.failhard);
             FStar_TypeChecker_Env.nosynth =
               (uu___1435_8116.FStar_TypeChecker_Env.nosynth);
             FStar_TypeChecker_Env.uvar_subtyping =
               (uu___1435_8116.FStar_TypeChecker_Env.uvar_subtyping);
             FStar_TypeChecker_Env.tc_term =
               (uu___1435_8116.FStar_TypeChecker_Env.tc_term);
             FStar_TypeChecker_Env.type_of =
               (uu___1435_8116.FStar_TypeChecker_Env.type_of);
             FStar_TypeChecker_Env.universe_of =
               (uu___1435_8116.FStar_TypeChecker_Env.universe_of);
             FStar_TypeChecker_Env.check_type_of =
               (uu___1435_8116.FStar_TypeChecker_Env.check_type_of);
             FStar_TypeChecker_Env.use_bv_sorts =
               (uu___1435_8116.FStar_TypeChecker_Env.use_bv_sorts);
             FStar_TypeChecker_Env.qtbl_name_and_index =
               (uu___1435_8116.FStar_TypeChecker_Env.qtbl_name_and_index);
             FStar_TypeChecker_Env.normalized_eff_names =
               (uu___1435_8116.FStar_TypeChecker_Env.normalized_eff_names);
             FStar_TypeChecker_Env.fv_delta_depths =
               (uu___1435_8116.FStar_TypeChecker_Env.fv_delta_depths);
             FStar_TypeChecker_Env.proof_ns =
               (uu___1435_8116.FStar_TypeChecker_Env.proof_ns);
             FStar_TypeChecker_Env.synth_hook =
               (uu___1435_8116.FStar_TypeChecker_Env.synth_hook);
             FStar_TypeChecker_Env.try_solve_implicits_hook =
               (uu___1435_8116.FStar_TypeChecker_Env.try_solve_implicits_hook);
             FStar_TypeChecker_Env.splice =
               (uu___1435_8116.FStar_TypeChecker_Env.splice);
             FStar_TypeChecker_Env.mpreprocess =
               (uu___1435_8116.FStar_TypeChecker_Env.mpreprocess);
             FStar_TypeChecker_Env.postprocess =
               (uu___1435_8116.FStar_TypeChecker_Env.postprocess);
             FStar_TypeChecker_Env.is_native_tactic =
               (uu___1435_8116.FStar_TypeChecker_Env.is_native_tactic);
             FStar_TypeChecker_Env.identifier_info =
               (uu___1435_8116.FStar_TypeChecker_Env.identifier_info);
             FStar_TypeChecker_Env.tc_hooks =
               (uu___1435_8116.FStar_TypeChecker_Env.tc_hooks);
             FStar_TypeChecker_Env.dsenv =
               (uu___1435_8116.FStar_TypeChecker_Env.dsenv);
             FStar_TypeChecker_Env.nbe =
               (uu___1435_8116.FStar_TypeChecker_Env.nbe);
             FStar_TypeChecker_Env.strict_args_tab =
               (uu___1435_8116.FStar_TypeChecker_Env.strict_args_tab);
             FStar_TypeChecker_Env.erasable_types_tab =
               (uu___1435_8116.FStar_TypeChecker_Env.erasable_types_tab)
           }  in
         let uu____8123 = tc_modul env1 m b  in
         match uu____8123 with
         | (m1,env2) ->
             ((let uu____8135 =
                 let uu____8137 =
                   FStar_Ident.string_of_lid m1.FStar_Syntax_Syntax.name  in
                 FStar_Options.dump_module uu____8137  in
               if uu____8135
               then
                 let uu____8140 = FStar_Syntax_Print.modul_to_string m1  in
              ...
              (let uu____8146 =
                 (let uu____8150 =
                    FStar_Ident.string_of_lid m1.FStar_Syntax_Syntax.name  in
                  FStar_Options.dump_module uu____8150) &&
                   (let uu____8153 =
                      FStar_Ident.string_of_lid m1.FStar_Syntax_Syntax.name
                       in
                    FStar_Options.debug_at_level uu____8153
                   ...
                   | FStar_Syntax_Syntax.Sig_let ((b1,lbs),ids) ->
                       ...
                       let update lb =
                         ...
                         | (univnames1,e) ->
                             ...
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___1457_8198.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___1457_8198.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___1457_8198.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___1457_8198.FStar_Syntax_Syntax.lbeff);
                               FStar_Syntax_Syntax.lbdef = uu____8199;
                               FStar_Syntax_Syntax.lbattrs =
                                 (uu___1457_8198.FStar_Syntax_Syntax.lbattrs);
                               FStar_Syntax_Syntax.lbpos =
                                 (uu___1457_8198.FStar_Syntax_Syntax.lbpos)
                             }
                          in
                       let uu___1459_8203 = se  in
                       let uu____8204 =
                         let uu____8205 =
                           let uu____8212 =
                             let uu____8213 = FStar_List.map update lbs  in
                             (b1, uu____8213)  in
                           (uu____8212, ids)  in
                         FStar_Syntax_Syntax.Sig_let uu____8205  in
                       {
                         ...
                         FStar_Syntax_Syntax.sigrng =
                           (uu___1459_8203.FStar_Syntax_Syntax.sigrng);
                         FStar_Syntax_Syntax.sigquals =
                           (uu___1459_8203.FStar_Syntax_Syntax.sigquals);
                         FStar_Syntax_Syntax.sigmeta =
                           (uu___1459_8203.FStar_Syntax_Syntax.sigmeta);
                         FStar_Syntax_Syntax.sigattrs =
                           (uu___1459_8203.FStar_Syntax_Syntax.sigattrs);
                         FStar_Syntax_Syntax.sigopts =
                           (uu___1459_8203.FStar_Syntax_Syntax.sigopts)
                       }
                   | uu____8221 -> se  in
                 let normalized_module =
                   let uu___1463_8223 = m1  in
                   let uu____8224 =
                   ...
                   {
                     FStar_Syntax_Syntax.name =
                       (uu___1463_8223.FStar_Syntax_Syntax.name);
                     FStar_Syntax_Syntax.declarations = uu____8224;
                     FStar_Syntax_Syntax.exports =
                       (uu___1463_8223.FStar_Syntax_Syntax.exports);
                     FStar_Syntax_Syntax.is_interface =
                       (uu___1463_8223.FStar_Syntax_Syntax.is_interface)
                   }  in
                 let uu____8225 =
