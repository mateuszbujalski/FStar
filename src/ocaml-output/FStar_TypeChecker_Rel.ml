...
let binders_eq :
  'Auu____6591 'Auu____6592 .
    (FStar_Syntax_Syntax.bv * 'Auu____6591) Prims.list ->
      (FStar_Syntax_Syntax.bv * 'Auu____6592) Prims.list -> Prims.bool
  =
  fun v1  ->
    fun v2  ->
...
let name_exists_in_binders :
  'Auu____6688 .
    FStar_Syntax_Syntax.bv ->
      (FStar_Syntax_Syntax.bv * 'Auu____6688) Prims.list -> Prims.bool
  =
  fun x  ->
    fun bs  ->
      FStar_Util.for_some
...
let pat_vars :
  'Auu____6736 .
    FStar_TypeChecker_Env.env ->
      (FStar_Syntax_Syntax.bv * 'Auu____6736) Prims.list ->
    ...
    fun t1  ->
      fun t2  ->
        ...
        | (FStar_Syntax_Syntax.Tm_app
           (head1,uu____7615),FStar_Syntax_Syntax.Tm_app (head',uu____7617))
            ->
            let uu____7666 = head_matches env head1 head'  in
            FStar_All.pipe_right uu____7666 head_match
        | (FStar_Syntax_Syntax.Tm_app (head1,uu____7668),uu____7669) ->
            let uu____7694 = head_matches env head1 t21  in
            FStar_All.pipe_right uu____7694 head_match
        | (uu____7695,FStar_Syntax_Syntax.Tm_app (head1,uu____7697)) ->
            let uu____7722 = head_matches env t11 head1  in
        ...
        fun t2  ->
          let maybe_inline t =
            ...
            (let uu____7926 =
             ...
             then
               ...
               let uu____7933 = FStar_Syntax_Print.term_to_string head1  in
               FStar_Util.print2 "Head of %s is %s\n" uu____7931 uu____7933
             else ());
            (let uu____7938 =
               let uu____7939 = FStar_Syntax_Util.un_uinst head1  in
          ...
          let rec aux retry1 n_delta t11 t21 =
            ...
            (let reduce_one_and_try_again d1 d2 =
             ...
             | MisMatch uu____8449 -> fail1 n_delta r t11 t21
    ...
    fun p  ->
      ...
      | FStar_TypeChecker_Common.TProb p1 ->
          ...
          FStar_All.pipe_right uu____8654
            (fun _8659  -> FStar_TypeChecker_Common.TProb _8659)
                     ...
                     | (rank,tp1) ->
                         let uu____9083 =
                           FStar_All.pipe_right
                             ...
                             (fun _9090  ->
                                FStar_TypeChecker_Common.TProb _9090)
                            in
                         (rank, uu____9083))))
      | FStar_TypeChecker_Common.CProb cp ->
          let uu____9094 =
            FStar_All.pipe_right
              (let uu___1290_9098 = cp  in
               ...
               }) (fun _9101  -> FStar_TypeChecker_Common.CProb _9101)
             in
    ...
    let rec aux uu____9161 probs =
      ...
      | (min_rank,min1,out) ->
          (match probs with
           ...
           | hd1::tl1 ->
               let uu____9263 = rank wl.tcenv hd1  in
    ...
    fun bs  ->
      fun p  ->
        let flex_will_be_closed t =
          ...
          | (hd1,uu____9421) ->
              let uu____9446 =
                let uu____9447 = FStar_Syntax_Subst.compress hd1  in
          ...
          let rec filter_out_common_univs u12 u22 =
            ...
            let filter1 =
              FStar_List.filter
               ...
               in
            let uu____9862 = filter1 u12  in
            let uu____9865 = filter1 u22  in (uu____9862, uu____9865)  in
...
let is_flex_pat :
  'Auu____10671 'Auu____10672 'Auu____10673 .
    ('Auu____10671 * 'Auu____10672 * 'Auu____10673 Prims.list) -> Prims.bool
  =
  fun uu___25_10687  ->
                       ...
                       | (formals,c) ->
                           let rec aux bs bs_terms formals1 wl1 =
                             ...
                             | (x,imp)::formals2 ->
                              ...
                              in
                           let uu____14846 = occurs_check u_lhs arrow1  in
          ...
          fun wl  ->
            fun rhs  ->
              ...
              (let rec aux wl1 scope env1 subst1 xs ys =
                 match (xs, ys) with
                 | ([],[]) ->
                     let uu____15053 = rhs wl1 scope env1 subst1  in
                                ...
                                (let try_branches =
                                 ...
                                 let uu____18990 =
                                   FStar_Util.find_map try_branches
                                    ...
                                    in
                                 FStar_All.pipe_left
                                   (fun _19033  -> FStar_Util.Inr _19033)
                                   uu____18990))
                                ...
                                | (p,uu____19072,e) ->
                                    ((let uu____19091 =
                                     ...
                                     (let uu____19103 =
                                      ...
                                      FStar_All.pipe_left
                                        (fun _19118  -> FStar_Util.Inr _19118)
                                        uu____19103)))))
                 | ((s,t),(uu____19121,{
                                         FStar_Syntax_Syntax.n =
                                           FStar_Syntax_Syntax.Tm_match
                                ...
                                (let try_branches =
                                 ...
                                 let uu____19842 =
                                   FStar_Util.find_map try_branches
                                    ...
                                    in
                                 FStar_All.pipe_left
                                   (fun _19885  -> FStar_Util.Inr _19885)
                                   uu____19842))
                           | FStar_Pervasives_Native.Some b ->
                               let uu____19915 =
                                 FStar_Syntax_Subst.open_branch b  in
                                ...
                                | (p,uu____19924,e) ->
                                    ((let uu____19943 =
                                     ...
                                     (let uu____19955 =
                                        try_solve_branch scrutinee p  in
                                      FStar_All.pipe_left
                                        (fun _19970  -> FStar_Util.Inr _19970)
                                        uu____19955)))))
                 | uu____19971 ->
                     ((let uu____19993 =
                         FStar_All.pipe_left
                ...
                (match (m, o) with
                 | (MisMatch uu____20093,uu____20094) ->
                     let rec may_relate head3 =
                       let uu____20122 =
                         let uu____20123 = FStar_Syntax_Subst.compress head3
                            in
                          ...
                          fun uu____27049  ->
                            fun uu____27050  ->
                              ...
                              | ((a1,uu____27094),(a2,uu____27096),(is_sub_probs,wl2))
                                  ->
                                  let uu____27129 = is_uvar1 a1  in
                                  if uu____27129
                                  then
                                    ((let uu____27139 =
                                        FStar_All.pipe_left
          ...
          fun t2  ->
            let x =
              let uu____29645 =
                ...
                FStar_All.pipe_left
                  (fun _29651  -> FStar_Pervasives_Native.Some _29651)
                  uu____29648
                 in
    ...
    fun prob  ->
      fun dopt  ->
        ...
        | FStar_Pervasives_Native.Some (deferred,implicits) ->
              ...
              let uu____29906 =
                let uu____29907 =
                  FStar_All.pipe_right (p_guard prob)
                    (fun _29908  ->
                       FStar_TypeChecker_Common.NonTrivial _29908)
                   in
                {
            ...
            FStar_All.pipe_left
              (fun _29915  -> FStar_Pervasives_Native.Some _29915)
              uu____29905
      ...
      fun dopt  ->
        ...
        | FStar_Pervasives_Native.Some (deferred,implicits) ->
            let uu____29965 =
              let uu____29966 =
                FStar_All.pipe_right (p_guard prob)
                  (fun _29967  -> FStar_TypeChecker_Common.NonTrivial _29967)
                 in
              {
    ...
    fun env  ->
      fun uu____30379  ->
        ...
        | (variables,ineqs) ->
            ...
            let equiv1 v1 v' =
              let uu____30449 =
                let uu____30454 = FStar_Syntax_Subst.compress_univ v1  in
            ...
            let sols =
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v1  ->
                      let uu____30506 = FStar_Syntax_Subst.compress_univ v1
                         in
                            ...
                            FStar_All.pipe_right ineqs
                              (FStar_List.collect
                                 (fun uu____30542  ->
                                    ...
                                    | (u,v') ->
                                        let uu____30551 = equiv1 v1 v'  in
                                        if uu____30551
                                        then
                                          let uu____30556 =
                                            FStar_All.pipe_right variables
              ...
              FStar_All.pipe_right ineqs
                (FStar_Util.for_all
                   (fun uu____30715  ->
                      ...
                      | (u,v1) ->
                          let uu____30723 = check_ineq (u, v1)  in
                          if uu____30723
                          then true
                          else
                            ((let uu____30731 =
  ...
  fun defer_ok  ->
    fun env  ->
      fun g  ->
        ...
        (let g1 =
           let uu____30893 = solve_and_commit env wl fail1  in
                                              ...
                                              | (env1,goal,opts) ->
                                                  let uu____31189 =
                                                    norm_with_steps
                                                      ...
                                                      env1 goal
                                                     in
                                                  (env1, uu____31189, opts)))))
                              else
                                (let uu____31193 =
                                   let uu____31200 = FStar_Options.peek ()
                                      in
                                   (env, vc2, uu____31200)  in
                                 [uu____31193])
                               in
                            FStar_All.pipe_right vcs
                              (FStar_List.iter
                                              ...
                                              then
                                                (let uu____31254 =
                                                 ...
                                                 let uu____31255 =
                                                   ...
                                                   FStar_Util.format2
                                                     "Trying to solve:\n> %s\nWith proof_ns:\n %s\n"
                                                     uu____31257 uu____31259
                                                    in
                                                 FStar_Errors.diag
                                                   uu____31254 uu____31255)
                                              else ();
                                              if debug1
                                              then
                                                (let uu____31266 =
...
let (discharge_guard_no_smt :
  ...
  fun env  ->
    fun g  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____31296 = FStar_TypeChecker_Env.get_range env  in
          FStar_Errors.raise_error
            (FStar_Errors.Fatal_ExpectTrivialPreCondition,
              "Expected a trivial pre-condition") uu____31296
...
let (teq_nosmt :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____31340 = try_teq false env t1 t2  in
          ...
          let rec unresolved ctx_u =
            let uu____31384 =
              FStar_Syntax_Unionfind.find
               ...
               in
            match uu____31384 with
            | FStar_Pervasives_Native.Some r ->
                (match ctx_u.FStar_Syntax_Syntax.ctx_uvar_meta with
                 | FStar_Pervasives_Native.None  -> false
                 | FStar_Pervasives_Native.Some uu____31397 ->
                     let uu____31410 =
                       let uu____31411 = FStar_Syntax_Subst.compress r  in
                       uu____31411.FStar_Syntax_Syntax.n  in
                     (match uu____31410 with
                      | FStar_Syntax_Syntax.Tm_uvar (ctx_u',uu____31416) ->
                          unresolved ctx_u'
                      | uu____31433 -> false))
            | FStar_Pervasives_Native.None  -> true  in
          let rec until_fixpoint acc implicits =
            let uu____31457 = acc  in
            match uu____31457 with
            | (out,changed) ->
                     ...
                     (match uu____31476 with
                      | { FStar_TypeChecker_Common.imp_reason = reason;
                          ...
                          then until_fixpoint (out, true) tl1
                            ...
                            (let uu____31487 = unresolved ctx_u  in
                             if uu____31487
                             then
                                   ...
                                   ((let uu____31511 =
                                    ...
                                    (let t =
                                       env1.FStar_TypeChecker_Env.synth_hook
                                        ...
                                        in
                                     let extra =
                                       let uu____31524 = teq_nosmt env1 t tm
                                          in
                                       ...
                                       | FStar_Pervasives_Native.Some g1 ->
                                        ...
                                        in
                                     let ctx_u1 =
                                       let uu___4259_31534 = ctx_u  in
                                       {
                                         FStar_Syntax_Syntax.ctx_uvar_head =
                                           (uu___4259_31534.FStar_Syntax_Syntax.ctx_uvar_head);
                                         FStar_Syntax_Syntax.ctx_uvar_gamma =
                                           (uu___4259_31534.FStar_Syntax_Syntax.ctx_uvar_gamma);
                                         FStar_Syntax_Syntax.ctx_uvar_binders
                                           =
                                           (uu___4259_31534.FStar_Syntax_Syntax.ctx_uvar_binders);
                                         FStar_Syntax_Syntax.ctx_uvar_typ =
                                           (uu___4259_31534.FStar_Syntax_Syntax.ctx_uvar_typ);
                                         FStar_Syntax_Syntax.ctx_uvar_reason
                                           =
                                           (uu___4259_31534.FStar_Syntax_Syntax.ctx_uvar_reason);
                                         FStar_Syntax_Syntax.ctx_uvar_should_check
                                           =
                                           (uu___4259_31534.FStar_Syntax_Syntax.ctx_uvar_should_check);
                                         FStar_Syntax_Syntax.ctx_uvar_range =
                                           (uu___4259_31534.FStar_Syntax_Syntax.ctx_uvar_range);
                                         FStar_Syntax_Syntax.ctx_uvar_meta =
                                           FStar_Pervasives_Native.None
                                       }  in
                                     let hd2 =
                                       let uu___4262_31542 = hd1  in
                                       {
                                         FStar_TypeChecker_Common.imp_reason
                                           =
                                           (uu___4262_31542.FStar_TypeChecker_Common.imp_reason);
                                         FStar_TypeChecker_Common.imp_uvar =
                                           ctx_u1;
                                         FStar_TypeChecker_Common.imp_tm =
                                           (uu___4262_31542.FStar_TypeChecker_Common.imp_tm);
                                         FStar_TypeChecker_Common.imp_range =
                                           (uu___4262_31542.FStar_TypeChecker_Common.imp_range)
                                       }  in
                               ...
                               then until_fixpoint (out, true) tl1
                                 ...
                                 (let env1 =
                                    let uu___4266_31553 = env  in
                                    {
                                      FStar_TypeChecker_Env.solver =
                                        (uu___4266_31553.FStar_TypeChecker_Env.solver);
                                      FStar_TypeChecker_Env.range =
                                        (uu___4266_31553.FStar_TypeChecker_Env.range);
                                      FStar_TypeChecker_Env.curmodule =
                                        (uu___4266_31553.FStar_TypeChecker_Env.curmodule);
                                      FStar_TypeChecker_Env.gamma =
                                        (ctx_u.FStar_Syntax_Syntax.ctx_uvar_gamma);
                                      FStar_TypeChecker_Env.gamma_sig =
                                        (uu___4266_31553.FStar_TypeChecker_Env.gamma_sig);
                                      FStar_TypeChecker_Env.gamma_cache =
                                        (uu___4266_31553.FStar_TypeChecker_Env.gamma_cache);
                                      FStar_TypeChecker_Env.modules =
                                        (uu___4266_31553.FStar_TypeChecker_Env.modules);
                                      FStar_TypeChecker_Env.expected_typ =
                                        (uu___4266_31553.FStar_TypeChecker_Env.expected_typ);
                                      FStar_TypeChecker_Env.sigtab =
                                        (uu___4266_31553.FStar_TypeChecker_Env.sigtab);
                                      FStar_TypeChecker_Env.attrtab =
                                        (uu___4266_31553.FStar_TypeChecker_Env.attrtab);
                                      FStar_TypeChecker_Env.instantiate_imp =
                                        (uu___4266_31553.FStar_TypeChecker_Env.instantiate_imp);
                                      FStar_TypeChecker_Env.effects =
                                        (uu___4266_31553.FStar_TypeChecker_Env.effects);
                                      FStar_TypeChecker_Env.generalize =
                                        (uu___4266_31553.FStar_TypeChecker_Env.generalize);
                                      FStar_TypeChecker_Env.letrecs =
                                        (uu___4266_31553.FStar_TypeChecker_Env.letrecs);
                                      FStar_TypeChecker_Env.top_level =
                                        (uu___4266_31553.FStar_TypeChecker_Env.top_level);
                                      FStar_TypeChecker_Env.check_uvars =
                                        (uu___4266_31553.FStar_TypeChecker_Env.check_uvars);
                                      FStar_TypeChecker_Env.use_eq =
                                        (uu___4266_31553.FStar_TypeChecker_Env.use_eq);
                                      FStar_TypeChecker_Env.use_eq_strict =
                                        (uu___4266_31553.FStar_TypeChecker_Env.use_eq_strict);
                                      FStar_TypeChecker_Env.is_iface =
                                        (uu___4266_31553.FStar_TypeChecker_Env.is_iface);
                                      FStar_TypeChecker_Env.admit =
                                        (uu___4266_31553.FStar_TypeChecker_Env.admit);
                                      FStar_TypeChecker_Env.lax =
                                        (uu___4266_31553.FStar_TypeChecker_Env.lax);
                                      FStar_TypeChecker_Env.lax_universes =
                                        (uu___4266_31553.FStar_TypeChecker_Env.lax_universes);
                                      FStar_TypeChecker_Env.phase1 =
                                        (uu___4266_31553.FStar_TypeChecker_Env.phase1);
                                      FStar_TypeChecker_Env.failhard =
                                        (uu___4266_31553.FStar_TypeChecker_Env.failhard);
                                      FStar_TypeChecker_Env.nosynth =
                                        (uu___4266_31553.FStar_TypeChecker_Env.nosynth);
                                      FStar_TypeChecker_Env.uvar_subtyping =
                                        (uu___4266_31553.FStar_TypeChecker_Env.uvar_subtyping);
                                      FStar_TypeChecker_Env.tc_term =
                                        (uu___4266_31553.FStar_TypeChecker_Env.tc_term);
                                      FStar_TypeChecker_Env.type_of =
                                        (uu___4266_31553.FStar_TypeChecker_Env.type_of);
                                      FStar_TypeChecker_Env.universe_of =
                                        (uu___4266_31553.FStar_TypeChecker_Env.universe_of);
                                      FStar_TypeChecker_Env.check_type_of =
                                        (uu___4266_31553.FStar_TypeChecker_Env.check_type_of);
                                      FStar_TypeChecker_Env.use_bv_sorts =
                                        (uu___4266_31553.FStar_TypeChecker_Env.use_bv_sorts);
                                      FStar_TypeChecker_Env.qtbl_name_and_index
                                        =
                                        (uu___4266_31553.FStar_TypeChecker_Env.qtbl_name_and_index);
                                      FStar_TypeChecker_Env.normalized_eff_names
                                        =
                                        (uu___4266_31553.FStar_TypeChecker_Env.normalized_eff_names);
                                      FStar_TypeChecker_Env.fv_delta_depths =
                                        (uu___4266_31553.FStar_TypeChecker_Env.fv_delta_depths);
                                      FStar_TypeChecker_Env.proof_ns =
                                        (uu___4266_31553.FStar_TypeChecker_Env.proof_ns);
                                      FStar_TypeChecker_Env.synth_hook =
                                        (uu___4266_31553.FStar_TypeChecker_Env.synth_hook);
                                      FStar_TypeChecker_Env.try_solve_implicits_hook
                                        =
                                        (uu___4266_31553.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                      FStar_TypeChecker_Env.splice =
                                        (uu___4266_31553.FStar_TypeChecker_Env.splice);
                                      FStar_TypeChecker_Env.mpreprocess =
                                        (uu___4266_31553.FStar_TypeChecker_Env.mpreprocess);
                                      FStar_TypeChecker_Env.postprocess =
                                        (uu___4266_31553.FStar_TypeChecker_Env.postprocess);
                                      FStar_TypeChecker_Env.is_native_tactic
                                        =
                                        (uu___4266_31553.FStar_TypeChecker_Env.is_native_tactic);
                                      FStar_TypeChecker_Env.identifier_info =
                                        (uu___4266_31553.FStar_TypeChecker_Env.identifier_info);
                                      FStar_TypeChecker_Env.tc_hooks =
                                        (uu___4266_31553.FStar_TypeChecker_Env.tc_hooks);
                                      FStar_TypeChecker_Env.dsenv =
                                        (uu___4266_31553.FStar_TypeChecker_Env.dsenv);
                                      FStar_TypeChecker_Env.nbe =
                                        (uu___4266_31553.FStar_TypeChecker_Env.nbe);
                                      FStar_TypeChecker_Env.strict_args_tab =
                                        (uu___4266_31553.FStar_TypeChecker_Env.strict_args_tab);
                                      FStar_TypeChecker_Env.erasable_types_tab
                                        =
                                        (uu___4266_31553.FStar_TypeChecker_Env.erasable_types_tab)
                                    }  in
                                  let tm1 =
                                    norm_with_steps
                                  ...
                                  let env2 =
                                    if forcelax
                                    then
                                      let uu___4271_31558 = env1  in
                                      {
                                        FStar_TypeChecker_Env.solver =
                                          (uu___4271_31558.FStar_TypeChecker_Env.solver);
                                        FStar_TypeChecker_Env.range =
                                          (uu___4271_31558.FStar_TypeChecker_Env.range);
                                        FStar_TypeChecker_Env.curmodule =
                                          (uu___4271_31558.FStar_TypeChecker_Env.curmodule);
                                        FStar_TypeChecker_Env.gamma =
                                          (uu___4271_31558.FStar_TypeChecker_Env.gamma);
                                        FStar_TypeChecker_Env.gamma_sig =
                                          (uu___4271_31558.FStar_TypeChecker_Env.gamma_sig);
                                        FStar_TypeChecker_Env.gamma_cache =
                                          (uu___4271_31558.FStar_TypeChecker_Env.gamma_cache);
                                        FStar_TypeChecker_Env.modules =
                                          (uu___4271_31558.FStar_TypeChecker_Env.modules);
                                        FStar_TypeChecker_Env.expected_typ =
                                          (uu___4271_31558.FStar_TypeChecker_Env.expected_typ);
                                        FStar_TypeChecker_Env.sigtab =
                                          (uu___4271_31558.FStar_TypeChecker_Env.sigtab);
                                        FStar_TypeChecker_Env.attrtab =
                                          (uu___4271_31558.FStar_TypeChecker_Env.attrtab);
                                        FStar_TypeChecker_Env.instantiate_imp
                                          =
                                          (uu___4271_31558.FStar_TypeChecker_Env.instantiate_imp);
                                        FStar_TypeChecker_Env.effects =
                                          (uu___4271_31558.FStar_TypeChecker_Env.effects);
                                        FStar_TypeChecker_Env.generalize =
                                          (uu___4271_31558.FStar_TypeChecker_Env.generalize);
                                        FStar_TypeChecker_Env.letrecs =
                                          (uu___4271_31558.FStar_TypeChecker_Env.letrecs);
                                        FStar_TypeChecker_Env.top_level =
                                          (uu___4271_31558.FStar_TypeChecker_Env.top_level);
                                        FStar_TypeChecker_Env.check_uvars =
                                          (uu___4271_31558.FStar_TypeChecker_Env.check_uvars);
                                        FStar_TypeChecker_Env.use_eq =
                                          (uu___4271_31558.FStar_TypeChecker_Env.use_eq);
                                        FStar_TypeChecker_Env.use_eq_strict =
                                          (uu___4271_31558.FStar_TypeChecker_Env.use_eq_strict);
                                        FStar_TypeChecker_Env.is_iface =
                                          (uu___4271_31558.FStar_TypeChecker_Env.is_iface);
                                        FStar_TypeChecker_Env.admit =
                                          (uu___4271_31558.FStar_TypeChecker_Env.admit);
                                        FStar_TypeChecker_Env.lax = true;
                                        FStar_TypeChecker_Env.lax_universes =
                                          (uu___4271_31558.FStar_TypeChecker_Env.lax_universes);
                                        FStar_TypeChecker_Env.phase1 =
                                          (uu___4271_31558.FStar_TypeChecker_Env.phase1);
                                        FStar_TypeChecker_Env.failhard =
                                          (uu___4271_31558.FStar_TypeChecker_Env.failhard);
                                        FStar_TypeChecker_Env.nosynth =
                                          (uu___4271_31558.FStar_TypeChecker_Env.nosynth);
                                        FStar_TypeChecker_Env.uvar_subtyping
                                          =
                                          (uu___4271_31558.FStar_TypeChecker_Env.uvar_subtyping);
                                        FStar_TypeChecker_Env.tc_term =
                                          (uu___4271_31558.FStar_TypeChecker_Env.tc_term);
                                        FStar_TypeChecker_Env.type_of =
                                          (uu___4271_31558.FStar_TypeChecker_Env.type_of);
                                        FStar_TypeChecker_Env.universe_of =
                                          (uu___4271_31558.FStar_TypeChecker_Env.universe_of);
                                        FStar_TypeChecker_Env.check_type_of =
                                          (uu___4271_31558.FStar_TypeChecker_Env.check_type_of);
                                        FStar_TypeChecker_Env.use_bv_sorts =
                                          (uu___4271_31558.FStar_TypeChecker_Env.use_bv_sorts);
                                        FStar_TypeChecker_Env.qtbl_name_and_index
                                          =
                                          (uu___4271_31558.FStar_TypeChecker_Env.qtbl_name_and_index);
                                        FStar_TypeChecker_Env.normalized_eff_names
                                          =
                                          (uu___4271_31558.FStar_TypeChecker_Env.normalized_eff_names);
                                        FStar_TypeChecker_Env.fv_delta_depths
                                          =
                                          (uu___4271_31558.FStar_TypeChecker_Env.fv_delta_depths);
                                        FStar_TypeChecker_Env.proof_ns =
                                          (uu___4271_31558.FStar_TypeChecker_Env.proof_ns);
                                        FStar_TypeChecker_Env.synth_hook =
                                          (uu___4271_31558.FStar_TypeChecker_Env.synth_hook);
                                        FStar_TypeChecker_Env.try_solve_implicits_hook
                                          =
                                          (uu___4271_31558.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                        FStar_TypeChecker_Env.splice =
                                          (uu___4271_31558.FStar_TypeChecker_Env.splice);
                                        FStar_TypeChecker_Env.mpreprocess =
                                          (uu___4271_31558.FStar_TypeChecker_Env.mpreprocess);
                                        FStar_TypeChecker_Env.postprocess =
                                          (uu___4271_31558.FStar_TypeChecker_Env.postprocess);
                                        FStar_TypeChecker_Env.is_native_tactic
                                          =
                                          (uu___4271_31558.FStar_TypeChecker_Env.is_native_tactic);
                                        FStar_TypeChecker_Env.identifier_info
                                          =
                                          (uu___4271_31558.FStar_TypeChecker_Env.identifier_info);
                                        FStar_TypeChecker_Env.tc_hooks =
                                          (uu___4271_31558.FStar_TypeChecker_Env.tc_hooks);
                                        FStar_TypeChecker_Env.dsenv =
                                          (uu___4271_31558.FStar_TypeChecker_Env.dsenv);
                                        FStar_TypeChecker_Env.nbe =
                                          (uu___4271_31558.FStar_TypeChecker_Env.nbe);
                                        FStar_TypeChecker_Env.strict_args_tab
                                          =
                                          (uu___4271_31558.FStar_TypeChecker_Env.strict_args_tab);
                                        FStar_TypeChecker_Env.erasable_types_tab
                                          =
                                          (uu___4271_31558.FStar_TypeChecker_Env.erasable_types_tab)
                                      }
                                    else env1  in
                                  (let uu____31563 =
                                     FStar_All.pipe_left
                                   ...
                                   then
                                     ...
                                     FStar_Util.print5
                                       ...
                                       uu____31568 uu____31570 uu____31572
                                       reason uu____31574
                                   else ());
                                  (let g1 =
                                     try
                                         ...
                                         (FStar_Pervasives_Native.Some
                                            (fun uu____31642  ->
                                               ...
                                               FStar_Util.format4
                                                 ...
                                                 uu____31643 uu____31645
                                                 reason uu____31647)) env2 g1
                                         true
                                        in
                                     match uu____31631 with
                                   ...
                                   until_fixpoint
                                     ((FStar_List.append
                                         ...
                                         out), true) tl1)))))
             in
          let uu___4289_31655 = g  in
          let uu____31656 =
            until_fixpoint ([], false) g.FStar_TypeChecker_Common.implicits
             in
          {
            FStar_TypeChecker_Common.guard_f =
              (uu___4289_31655.FStar_TypeChecker_Common.guard_f);
            FStar_TypeChecker_Common.deferred =
              (uu___4289_31655.FStar_TypeChecker_Common.deferred);
            FStar_TypeChecker_Common.univ_ineqs =
              (uu___4289_31655.FStar_TypeChecker_Common.univ_ineqs);
            FStar_TypeChecker_Common.implicits = uu____31656
          }
...
let (force_trivial_guard :
  ...
  fun env  ->
    fun g  ->
      let g1 =
        let uu____31696 = solve_deferred_constraints env g  in
        FStar_All.pipe_right uu____31696 (resolve_implicits env)  in
      match g1.FStar_TypeChecker_Common.implicits with
      | [] ->
          let uu____31697 = discharge_guard env g1  in
          FStar_All.pipe_left (fun a2  -> ()) uu____31697
      | imp::uu____31699 ->
          let uu____31702 =
            let uu____31708 =
              let uu____31710 =
              ...
              FStar_Util.format3
                ...
                uu____31710 uu____31712
                imp.FStar_TypeChecker_Common.imp_reason
               in
            (FStar_Errors.Fatal_FailToResolveImplicitArgument, uu____31708)
             in
          FStar_Errors.raise_error uu____31702
...
let (teq_force :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____31732 = teq env t1 t2  in
        force_trivial_guard env uu____31732
...
let (teq_nosmt_force :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____31751 = teq_nosmt env t1 t2  in
...
let (universe_inequality :
  ...
  fun u1  ->
    fun u2  ->
      let uu___4314_31770 = FStar_TypeChecker_Common.trivial_guard  in
      {
        FStar_TypeChecker_Common.guard_f =
          (uu___4314_31770.FStar_TypeChecker_Common.guard_f);
        FStar_TypeChecker_Common.deferred =
          (uu___4314_31770.FStar_TypeChecker_Common.deferred);
        FStar_TypeChecker_Common.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Common.implicits =
          (uu___4314_31770.FStar_TypeChecker_Common.implicits)
      }
        ...
        (let uu____31818 =
         ...
         | (prob,x,wl) ->
             let g =
               let uu____31837 =
                 solve_and_commit env (singleton wl prob true)
                   (fun uu____31846  -> FStar_Pervasives_Native.None)
                  in
               FStar_All.pipe_left (with_guard env prob) uu____31837  in
             ((let uu____31864 =
                 (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                    (FStar_Options.Other "Rel"))
               ...
               then
                 ...
                 let uu____31871 =
                   FStar_TypeChecker_Normalize.term_to_string env t2  in
                 let uu____31873 =
                   let uu____31875 = FStar_Util.must g  in
                   guard_to_string env uu____31875  in
                 FStar_Util.print3
                   "check_subtyping succeeded: %s <: %s\n\tguard is %s\n"
                   uu____31869 uu____31871 uu____31873
               else ());
              (match g with
               | FStar_Pervasives_Native.None  ->
                   FStar_Pervasives_Native.None
    ...
    fun t1  ->
      fun t2  ->
        ...
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____31931 =
              let uu____31932 = FStar_Syntax_Syntax.mk_binder x  in
              FStar_TypeChecker_Env.abstract_guard uu____31932 g  in
...
let (get_subtyping_prop :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____31951 = check_subtyping env t1 t2  in
        match uu____31951 with
        | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____31970 =
              let uu____31971 =
                let uu____31972 = FStar_Syntax_Syntax.mk_binder x  in
                [uu____31972]  in
              FStar_TypeChecker_Env.close_guard env uu____31971 g  in
            FStar_Pervasives_Native.Some uu____31970
      ...
      fun t2  ->
        ...
        (let uu____32022 =
           new_t_prob (empty_worklist env) env t1
             FStar_TypeChecker_Common.SUB t2
            in
         match uu____32022 with
         | (prob,x,wl) ->
             let g =
               let uu____32037 =
                 solve_and_commit env (singleton wl prob false)
                   (fun uu____32046  -> FStar_Pervasives_Native.None)
                  in
               FStar_All.pipe_left (with_guard env prob) uu____32037  in
             (match g with
              | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
              | FStar_Pervasives_Native.Some g1 ->
                  let g2 =
                    let uu____32067 =
                      let uu____32068 = FStar_Syntax_Syntax.mk_binder x  in
                      [uu____32068]  in
                    FStar_TypeChecker_Env.close_guard env uu____32067 g1  in
...
let (subtype_nosmt_force :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____32109 = subtype_nosmt env t1 t2  in
