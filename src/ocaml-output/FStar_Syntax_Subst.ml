...
let tag_with_range :
  'Auu____782 .
    FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax ->
      ('Auu____782 * FStar_Syntax_Syntax.maybe_set_use_range) ->
        FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax
  =
  fun t  ->
    fun s  ->
...
let tag_lid_with_range :
  'Auu____844 .
    FStar_Ident.lident ->
      ('Auu____844 * FStar_Syntax_Syntax.maybe_set_use_range) ->
        FStar_Ident.lident
  =
  fun l  ->
    fun s  ->
...
let shift_subst' :
  'Auu____1363 .
    Prims.int ->
      (FStar_Syntax_Syntax.subst_t Prims.list * 'Auu____1363) ->
        (FStar_Syntax_Syntax.subst_t Prims.list * 'Auu____1363)
  =
  fun n1  ->
    fun s  ->
...
let subst_arg' :
  'Auu____1590 .
    FStar_Syntax_Syntax.subst_ts ->
      (FStar_Syntax_Syntax.term * 'Auu____1590) ->
        (FStar_Syntax_Syntax.term * 'Auu____1590)
  =
  fun s  ->
    fun uu____1608  ->
...
let subst_args' :
  'Auu____1622 .
    FStar_Syntax_Syntax.subst_ts ->
      (FStar_Syntax_Syntax.term * 'Auu____1622) Prims.list ->
        (FStar_Syntax_Syntax.term * 'Auu____1622) Prims.list
  ...
  fun s  ->
    fun p  ->
      let rec aux n1 p1 =
        ...
        | FStar_Syntax_Syntax.Pat_constant uu____1716 -> (p1, n1)
                ...
                FStar_All.pipe_right hd_subst
                  (FStar_List.collect
                     (fun uu___6_2181  ->
                        ...
                        | uu____2241 -> []))
                 in
              let uu____2242 = aux rest  in FStar_List.append hd1 uu____2242
           in
        let uu____2245 =
          aux
...
let (open_pat :
  ...
  fun p  ->
    let rec open_pat_aux sub1 p1 =
      match p1.FStar_Syntax_Syntax.v with
      | FStar_Syntax_Syntax.Pat_constant uu____4098 -> (p1, sub1)
      | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
          let uu____4123 =
            FStar_All.pipe_right pats
              (FStar_List.fold_left
                 (fun uu____4194  ->
                    fun uu____4195  ->
                      ...
                      | ((pats1,sub2),(p2,imp)) ->
                          let uu____4309 = open_pat_aux sub2 p2  in
      ...
      | FStar_Syntax_Syntax.Pat_var x ->
          let x' =
            ...
            let uu____4441 = subst sub1 x.FStar_Syntax_Syntax.sort  in
            {
              FStar_Syntax_Syntax.ppname =
          ...
          let sub2 =
            let uu____4447 = shift_subst Prims.int_one sub1  in
      ...
      | FStar_Syntax_Syntax.Pat_wild x ->
          let x' =
            ...
            let uu____4464 = subst sub1 x.FStar_Syntax_Syntax.sort  in
            {
              FStar_Syntax_Syntax.ppname =
          ...
          let sub2 =
            let uu____4470 = shift_subst Prims.int_one sub1  in
  ...
  fun bs  ->
    let rec aux s bs1 =
      ...
      | (x,imp)::tl1 ->
          ...
          let uu____4702 = aux s' tl1  in (x1, imp1) :: uu____4702
       in
    aux [] bs
...
let (close_pat :
  ...
  fun p  ->
    let rec aux sub1 p1 =
      match p1.FStar_Syntax_Syntax.v with
      | FStar_Syntax_Syntax.Pat_constant uu____4766 -> (p1, sub1)
      | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
          let uu____4791 =
            FStar_All.pipe_right pats
              (FStar_List.fold_left
      ...
      | FStar_Syntax_Syntax.Pat_var x ->
          let x1 =
            ...
            let uu____5109 = subst sub1 x.FStar_Syntax_Syntax.sort  in
            {
              FStar_Syntax_Syntax.ppname =
          ...
          let sub2 =
            let uu____5115 = shift_subst Prims.int_one sub1  in
      ...
      | FStar_Syntax_Syntax.Pat_wild x ->
          let x1 =
            ...
            let uu____5132 = subst sub1 x.FStar_Syntax_Syntax.sort  in
            {
              FStar_Syntax_Syntax.ppname =
          ...
          let sub2 =
            let uu____5138 = shift_subst Prims.int_one sub1  in
      ...
      | FStar_Syntax_Syntax.Pat_dot_term (x,t0) ->
          let x1 =
            ...
            let uu____5160 = subst sub1 x.FStar_Syntax_Syntax.sort  in
            {
              FStar_Syntax_Syntax.ppname =
      ...
      (FStar_List.mapi
         (fun i  ->
            fun uu____6067  ->
              ...
              | (x,uu____6076) -> FStar_Syntax_Syntax.DB ((n1 - i), x)))
