...
let arg_of_non_null_binder :
  'Auu____127 .
    (FStar_Syntax_Syntax.bv * 'Auu____127) ->
      (FStar_Syntax_Syntax.term * 'Auu____127)
  =
  fun uu____140  ->
...
let mk_subst : 'Auu____789 . 'Auu____789 -> 'Auu____789 Prims.list =
  fun s  -> [s] 
let (subst_of_list :
  FStar_Syntax_Syntax.binders ->
...
let rec (univ_kernel :
  ...
  fun u  ->
    ...
    | FStar_Syntax_Syntax.U_succ u1 ->
        ...
        (match uu____1146 with | (k,n1) -> (k, (n1 + Prims.int_one)))
...
let rec (head_and_args' :
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_app (head1,args) ->
        let uu____2265 = head_and_args' head1  in
...
let unlazy_as_t :
  'Auu____2861 .
    FStar_Syntax_Syntax.lazy_kind -> FStar_Syntax_Syntax.term -> 'Auu____2861
  =
  fun k  ->
    fun t  ->
      let uu____2872 =
  ...
  fun t1  ->
    fun t2  ->
      ...
      | (FStar_Syntax_Syntax.Tm_type u,FStar_Syntax_Syntax.Tm_type v1) ->
          let uu____4107 = eq_univs u v1  in equal_if uu____4107
...
let rec (is_unit : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_app (head1,uu____4992) -> is_unit head1
...
let range_of_arg :
  'Auu____5446 'Auu____5447 .
    ('Auu____5446 FStar_Syntax_Syntax.syntax * 'Auu____5447) ->
      FStar_Range.range
  =
  fun uu____5458  ->
    match uu____5458 with | (hd1,uu____5466) -> hd1.FStar_Syntax_Syntax.pos
  
let range_of_args :
  'Auu____5480 'Auu____5481 .
    ('Auu____5480 FStar_Syntax_Syntax.syntax * 'Auu____5481) Prims.list ->
                    ...
                    | (FStar_Pervasives_Native.Some fvs,uu____7868) ->
                        let universes =
                          FStar_All.pipe_right univ_vars
                            (FStar_List.map
                               (fun _7884  ->
                                  FStar_Syntax_Syntax.U_name _7884))
                           in
                        let inst1 =
...
let (type_u :
  ...
  fun uu____8368  ->
    let u =
      ...
      FStar_All.pipe_left (fun _8391  -> FStar_Syntax_Syntax.U_unif _8391)
        uu____8374
       in
    let uu____8392 =
...
let (unb2t :
  ...
  fun e  ->
    ...
    | (hd1,args) ->
        let uu____9147 =
          let uu____9162 =
            let uu____9163 = FStar_Syntax_Subst.compress hd1  in
...
let (un_squash :
  ...
  fun t  ->
    ...
    | (head1,args) ->
        ...
        let uu____10503 =
          let uu____10518 =
            let uu____10519 = FStar_Syntax_Subst.compress head3  in
...
let (is_auto_squash :
  ...
  fun t  ->
    ...
    | (head1,args) ->
        let uu____10953 =
          let uu____10968 =
            let uu____10969 = FStar_Syntax_Subst.compress head1  in
...
let (is_sub_singleton : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    ...
    | (head1,uu____11090) ->
        let uu____11115 =
          let uu____11116 = un_uinst head1  in
...
let (destruct_typ_as_formula :
  ...
  fun f  ->
    ...
    let destruct_base_conn t =
      ...
      | (hd1,args) ->
          let uu____12164 =
            let uu____12165 = un_uinst hd1  in
      ...
      FStar_Util.bind_opt uu____13461
        (fun t1  ->
           ...
           | (hd1,args) ->
               let uu____13531 =
                 let uu____13546 =
                   let uu____13547 = un_uinst hd1  in
      ...
      | FStar_Pervasives_Native.Some (QAll (bs,pats,phi)) ->
          ...
          (match uu____13806 with
           | FStar_Pervasives_Native.Some (QAll (bs',pats',psi)) ->
               FStar_All.pipe_left
                 (fun _13816  -> FStar_Pervasives_Native.Some _13816)
                 (QAll
      ...
      | FStar_Pervasives_Native.Some (QEx (bs,pats,phi)) ->
          ...
          (match uu____13829 with
           | FStar_Pervasives_Native.Some (QEx (bs',pats',psi)) ->
               FStar_All.pipe_left
                 (fun _13839  -> FStar_Pervasives_Native.Some _13839)
                 (QEx
                    ((FStar_List.append bs bs'),
                      (FStar_List.append pats pats'), psi))
           | uu____13846 -> f1)
...
let rec apply_last :
  'Auu____14376 .
    ('Auu____14376 -> 'Auu____14376) ->
      'Auu____14376 Prims.list -> 'Auu____14376 Prims.list
  =
  fun f  ->
    fun l  ->
      match l with
        ...
        FStar_List.fold_right
          (fun t  ->
             fun a  ->
               ...
               cons1 uu____14547 t.FStar_Syntax_Syntax.pos) l uu____14511
    ...
    fun attrs  ->
      FStar_List.tryPick
        (fun t  ->
           ...
           | (head1,args) ->
               let uu____16877 =
                 let uu____16878 = FStar_Syntax_Subst.compress head1  in
    ...
    fun r  ->
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____16972 = FStar_Options.restore_cmd_line_options false
               in
            FStar_All.pipe_right uu____16972 (fun a1  -> ()));
           (match sopt with
            | FStar_Pervasives_Native.None  -> ()
      ...
      | FStar_Syntax_Syntax.PopOptions  ->
          let uu____16987 = FStar_Options.internal_pop ()  in
          if uu____16987
          then ()
          else
            FStar_Errors.raise_error
...
let rec (unbound_variables :
  ...
  fun tm  ->
    ...
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____17019 -> failwith "Impossible"
  ...
  fun attr_lid  ->
    fun se  ->
      ...
      | FStar_Pervasives_Native.Some (attrs',t) ->
          FStar_Pervasives_Native.Some
            ((let uu___2474_18089 = se  in
              {
                FStar_Syntax_Syntax.sigel =
                  (uu___2474_18089.FStar_Syntax_Syntax.sigel);
                FStar_Syntax_Syntax.sigrng =
                  (uu___2474_18089.FStar_Syntax_Syntax.sigrng);
                FStar_Syntax_Syntax.sigquals =
                  (uu___2474_18089.FStar_Syntax_Syntax.sigquals);
                FStar_Syntax_Syntax.sigmeta =
                  (uu___2474_18089.FStar_Syntax_Syntax.sigmeta);
                FStar_Syntax_Syntax.sigattrs = attrs';
                FStar_Syntax_Syntax.sigopts =
                  (uu___2474_18089.FStar_Syntax_Syntax.sigopts)
              }), t)
...
let (smt_lemma_as_forall :
  ...
  fun t  ->
    fun universe_of_binders  ->
      ...
      let one_pat p =
        let uu____18718 =
          let uu____18735 = unmeta p  in
          FStar_All.pipe_right uu____18735 head_and_args  in
        match uu____18718 with
        | (head1,args) ->
            let uu____18786 =
              let uu____18801 =
                let uu____18802 = un_uinst head1  in
                uu____18802.FStar_Syntax_Syntax.n  in
              (uu____18801, args)  in
            (match uu____18786 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(uu____18824,uu____18825)::arg::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                 ...
                 let uu____18892 =
                   let uu____18898 =
                     ...
                     FStar_Util.format1
                       ...
                       uu____18900
                      in
                   (FStar_Errors.Error_IllSMTPat, uu____18898)  in
                 FStar_Errors.raise_error uu____18892
      ...
      let lemma_pats p =
        ...
        let smt_pat_or t1 =
          let uu____18943 =
            let uu____18960 = unmeta t1  in
            FStar_All.pipe_right uu____18960 head_and_args  in
          match uu____18943 with
          | (head1,args) ->
              let uu____19007 =
                let uu____19022 =
                  let uu____19023 = un_uinst head1  in
                  uu____19023.FStar_Syntax_Syntax.n  in
                (uu____19022, args)  in
              (match uu____19007 with
               | (FStar_Syntax_Syntax.Tm_fvar fv,(e,uu____19042)::[]) when
                   FStar_Syntax_Syntax.fv_eq_lid fv
                     FStar_Parser_Const.smtpatOr_lid
                   -> FStar_Pervasives_Native.Some e
               | uu____19079 -> FStar_Pervasives_Native.None)
           in
        match elts with
        | t1::[] ->
            let uu____19109 = smt_pat_or t1  in
            (match uu____19109 with
             | FStar_Pervasives_Native.Some e ->
                 let uu____19131 = list_elements1 e  in
                 FStar_All.pipe_right uu____19131
                   (FStar_List.map
                      (fun branch1  ->
                         let uu____19161 = list_elements1 branch1  in
                         FStar_All.pipe_right uu____19161
      ...
      let uu____19308 =
        let uu____19341 =
          let uu____19342 = FStar_Syntax_Subst.compress t  in
          uu____19342.FStar_Syntax_Syntax.n  in
        match uu____19341 with
        | FStar_Syntax_Syntax.Tm_arrow (binders,c) ->
            let uu____19399 = FStar_Syntax_Subst.open_comp binders c  in
            (match uu____19399 with
             | (binders1,c1) ->
                 (match c1.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Comp
                      { FStar_Syntax_Syntax.comp_univs = uu____19470;
                        FStar_Syntax_Syntax.effect_name = uu____19471;
                        FStar_Syntax_Syntax.result_typ = uu____19472;
                        FStar_Syntax_Syntax.effect_args =
                          (pre,uu____19474)::(post,uu____19476)::(pats,uu____19478)::[];
                        FStar_Syntax_Syntax.flags = uu____19479;_}
                      ->
                      let uu____19540 = lemma_pats pats  in
                      (binders1, pre, post, uu____19540)
                  | uu____19577 -> failwith "impos"))
        | uu____19611 -> failwith "Impos"  in
      ...
      | (binders,pre,post,patterns) ->
          ...
          let body =
            let uu____19703 =
              let uu____19710 =
                let uu____19711 =
                  let uu____19718 = mk_imp pre post1  in
                  let uu____19721 =
                    let uu____19722 =
                      let uu____19743 =
                        FStar_Syntax_Syntax.binders_to_names binders  in
                      (uu____19743, patterns)  in
                    FStar_Syntax_Syntax.Meta_pattern uu____19722  in
                  (uu____19718, uu____19721)  in
                FStar_Syntax_Syntax.Tm_meta uu____19711  in
              FStar_Syntax_Syntax.mk uu____19710  in
            uu____19703 FStar_Pervasives_Native.None
              t.FStar_Syntax_Syntax.pos
             in
          let quant =
            let uu____19767 = universe_of_binders binders  in
            FStar_List.fold_right2
              (fun b  ->
                 fun u  ->
                   fun out  ->
...
let (eff_decl_of_new_effect :
  ...
  fun se  ->
    ...
    | uu____19797 -> failwith "eff_decl_of_new_effect: not a Sig_new_effect"
  
let (is_layered : FStar_Syntax_Syntax.eff_decl -> Prims.bool) =
  fun ed  ->
    match ed.FStar_Syntax_Syntax.combinators with
    | FStar_Syntax_Syntax.Layered_eff uu____19808 -> true
    | uu____19810 -> false
  
let (is_dm4f : FStar_Syntax_Syntax.eff_decl -> Prims.bool) =
  fun ed  ->
    match ed.FStar_Syntax_Syntax.combinators with
    | FStar_Syntax_Syntax.DM4F_eff uu____19821 -> true
    | uu____19823 -> false
...
let (apply_wp_eff_combinators :
  ...
  fun f  ->
    fun combs  ->
      let uu____19841 = f combs.FStar_Syntax_Syntax.ret_wp  in
      let uu____19842 = f combs.FStar_Syntax_Syntax.bind_wp  in
      let uu____19843 = f combs.FStar_Syntax_Syntax.stronger  in
      let uu____19844 = f combs.FStar_Syntax_Syntax.if_then_else  in
      let uu____19845 = f combs.FStar_Syntax_Syntax.ite_wp  in
      let uu____19846 = f combs.FStar_Syntax_Syntax.close_wp  in
      let uu____19847 = f combs.FStar_Syntax_Syntax.trivial  in
      let uu____19848 =
      ...
      {
        FStar_Syntax_Syntax.ret_wp = uu____19841;
        FStar_Syntax_Syntax.bind_wp = uu____19842;
        FStar_Syntax_Syntax.stronger = uu____19843;
        FStar_Syntax_Syntax.if_then_else = uu____19844;
        FStar_Syntax_Syntax.ite_wp = uu____19845;
        FStar_Syntax_Syntax.close_wp = uu____19846;
        FStar_Syntax_Syntax.trivial = uu____19847;
        FStar_Syntax_Syntax.repr = uu____19848;
        FStar_Syntax_Syntax.return_repr = uu____19851;
        FStar_Syntax_Syntax.bind_repr = uu____19854
      }
...
let (apply_layered_eff_combinators :
  ...
  fun f  ->
    fun combs  ->
      let map_tuple uu____19886 =
        match uu____19886 with
        | (ts1,ts2) ->
            let uu____19897 = f ts1  in
            let uu____19898 = f ts2  in (uu____19897, uu____19898)
         in
      let uu____19899 = map_tuple combs.FStar_Syntax_Syntax.l_repr  in
      let uu____19904 = map_tuple combs.FStar_Syntax_Syntax.l_return  in
      let uu____19909 = map_tuple combs.FStar_Syntax_Syntax.l_bind  in
      let uu____19914 = map_tuple combs.FStar_Syntax_Syntax.l_subcomp  in
      let uu____19919 = map_tuple combs.FStar_Syntax_Syntax.l_if_then_else
         in
      {
        FStar_Syntax_Syntax.l_base_effect =
          (combs.FStar_Syntax_Syntax.l_base_effect);
        FStar_Syntax_Syntax.l_repr = uu____19899;
        FStar_Syntax_Syntax.l_return = uu____19904;
        FStar_Syntax_Syntax.l_bind = uu____19909;
        FStar_Syntax_Syntax.l_subcomp = uu____19914;
        FStar_Syntax_Syntax.l_if_then_else = uu____19919
      }
  ...
  fun f  ->
    fun combs  ->
      ...
      | FStar_Syntax_Syntax.Primitive_eff combs1 ->
          let uu____19941 = apply_wp_eff_combinators f combs1  in
          FStar_Syntax_Syntax.Primitive_eff uu____19941
      | FStar_Syntax_Syntax.DM4F_eff combs1 ->
          let uu____19943 = apply_wp_eff_combinators f combs1  in
          FStar_Syntax_Syntax.DM4F_eff uu____19943
      | FStar_Syntax_Syntax.Layered_eff combs1 ->
          let uu____19945 = apply_layered_eff_combinators f combs1  in
          FStar_Syntax_Syntax.Layered_eff uu____19945
  ...
  fun ed  ->
    ...
    | FStar_Syntax_Syntax.Layered_eff combs ->
        ...
        FStar_All.pipe_right uu____20021
          (fun _20028  -> FStar_Pervasives_Native.Some _20028)
  ...
  fun ed  ->
    ...
    | FStar_Syntax_Syntax.Primitive_eff combs ->
        FStar_All.pipe_right combs.FStar_Syntax_Syntax.trivial
          (fun _20063  -> FStar_Pervasives_Native.Some _20063)
    | FStar_Syntax_Syntax.DM4F_eff combs ->
        FStar_All.pipe_right combs.FStar_Syntax_Syntax.trivial
          (fun _20067  -> FStar_Pervasives_Native.Some _20067)
    | uu____20068 -> FStar_Pervasives_Native.None
  ...
  fun ed  ->
    ...
    | FStar_Syntax_Syntax.Layered_eff combs ->
        ...
        FStar_All.pipe_right uu____20080
          (fun _20087  -> FStar_Pervasives_Native.Some _20087)
    | uu____20088 -> FStar_Pervasives_Native.None
  ...
  fun ed  ->
    ...
    | FStar_Syntax_Syntax.Primitive_eff combs ->
        FStar_All.pipe_right combs.FStar_Syntax_Syntax.if_then_else
          (fun _20102  -> FStar_Pervasives_Native.Some _20102)
    | FStar_Syntax_Syntax.DM4F_eff combs ->
        FStar_All.pipe_right combs.FStar_Syntax_Syntax.if_then_else
  ...
  fun ed  ->
    ...
    | FStar_Syntax_Syntax.Primitive_eff combs ->
        FStar_All.pipe_right combs.FStar_Syntax_Syntax.ite_wp
          (fun _20121  -> FStar_Pervasives_Native.Some _20121)
    | FStar_Syntax_Syntax.DM4F_eff combs ->
        FStar_All.pipe_right combs.FStar_Syntax_Syntax.ite_wp
          (fun _20125  -> FStar_Pervasives_Native.Some _20125)
    | uu____20126 -> FStar_Pervasives_Native.None
...
let (get_stronger_repr :
  ...
  fun ed  ->
    match ed.FStar_Syntax_Syntax.combinators with
    | FStar_Syntax_Syntax.Primitive_eff uu____20150 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.DM4F_eff uu____20151 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Layered_eff combs ->
        let uu____20153 =
          FStar_All.pipe_right combs.FStar_Syntax_Syntax.l_subcomp
            FStar_Pervasives_Native.fst
           in
        FStar_All.pipe_right uu____20153
          (fun _20160  -> FStar_Pervasives_Native.Some _20160)
  ...
  fun ed  ->
    ...
    | FStar_Syntax_Syntax.Layered_eff combs ->
        FStar_All.pipe_right combs.FStar_Syntax_Syntax.l_base_effect
          (fun _20174  -> FStar_Pervasives_Native.Some _20174)
