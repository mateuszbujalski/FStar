                              ...
                              | (guard,decls11) ->
                                  ...
                                  let should_thunk uu____7978 =
                                    ...
                                    (((let uu____8069 = FStar_Ident.nsstr lid
                                       ...
                                       &&
                                       (let uu____8080 = is_squash1 t_norm
                                           in
                                        Prims.op_Negation uu____8080))
                                      &&
                                      (let uu____8083 = is_type1 t_norm  in
...
let (is_tactic : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    ...
    | (hd1,args) ->
        let uu____9024 =
          let uu____9025 = FStar_Syntax_Util.un_uinst hd1  in
            ...
            let destruct_bound_function t e =
              ...
              let rec arrow_formals_comp_norm norm1 t1 =
                ...
                | FStar_Syntax_Syntax.Tm_refine uu____9705 ->
                    ...
                    arrow_formals_comp_norm norm1 uu____9712
                | uu____9713 when Prims.op_Negation norm1 ->
                    let t_norm =
                      norm_with_steps
                        [FStar_TypeChecker_Env.AllowUnboundUniverses;
                                ...
                                | FStar_SMTEncoding_Env.Inner_let_rec names1
                                    ...
                                    let plural =
                                      (FStar_List.length names1) >
                                       ...
                                       in
                                    let r =
                                      let uu____12630 = FStar_List.hd names1
                                         in
    ...
    fun se  ->
      ...
      (let is_opaque_to_smt t =
       ...
       | FStar_Syntax_Syntax.Sig_let
           ((uu____13736,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inr b2t1;
           ...
           (fun uu____17839  ->
              ...
              | (l,uu____17850,uu____17851) ->
                  let uu____17854 =
                    ...
                    FStar_All.pipe_left
                      (fun _17858  -> FStar_SMTEncoding_Term.Echo _17858)
                      uu____17855
                     in
                  let uu____17859 =
                    let uu____17862 =
...
let (set_env : FStar_SMTEncoding_Env.env_t -> unit) =
  fun env  ->
    ...
    | uu____18031::tl1 -> FStar_ST.op_Colon_Equals last_env (env :: tl1)
...
let (pop_env : unit -> unit) =
  fun uu____18124  ->
    ...
    | uu____18152::tl1 -> FStar_ST.op_Colon_Equals last_env tl1
