  ...
  fun msg  ->
    FStar_Tactics_Monad.mk_tac
      (fun ps  ->
         ...
         (let uu____212 = FStar_Tactics_Types.subst_proof_state subst1 ps  in
          FStar_Tactics_Printing.do_dump_proofstate uu____212 msg);
         FStar_Tactics_Result.Success ((), ps))
  
let fail1 :
  'Auu____220 .
    Prims.string -> Prims.string -> 'Auu____220 FStar_Tactics_Monad.tac
  =
  fun msg  ->
    fun x  ->
...
let fail2 :
  'Auu____248 .
    Prims.string ->
      Prims.string -> Prims.string -> 'Auu____248 FStar_Tactics_Monad.tac
  =
  fun msg  ->
    fun x  ->
      fun y  ->
...
let fail3 :
  'Auu____285 .
    Prims.string ->
      Prims.string ->
        Prims.string -> Prims.string -> 'Auu____285 FStar_Tactics_Monad.tac
  =
  fun msg  ->
    fun x  ->
      fun y  ->
...
let fail4 :
  'Auu____331 .
    Prims.string ->
      Prims.string ->
        Prims.string ->
          Prims.string -> Prims.string -> 'Auu____331 FStar_Tactics_Monad.tac
  =
  fun msg  ->
    fun x  ->
      fun y  ->
      ...
      fun t2  ->
        FStar_Tactics_Monad.bind FStar_Tactics_Monad.idtac
          (fun uu____756  ->
             ...
             (let uu____767 = __do_unify env t1 t2  in
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        ...
        let uu____810 = do_unify env t1 t2  in
    ...
    FStar_Tactics_Monad.bind FStar_Tactics_Monad.get
      (fun ps  ->
         ...
         FStar_Tactics_Monad.bind uu____1105
           (fun uu____1110  ->
              let uu____1111 = FStar_BigInt.of_int_fs n1  in
             ...
             let uu____1992 =
               try
                 (fun uu___377_2015  ->
                    ...
                    | () ->
                        let uu____2026 =
                          let uu____2035 = FStar_BigInt.to_int_fs n1  in
      ...
      fun tm  ->
        let uu____3174 =
          FStar_Tactics_Monad.mlog
            ...
            (fun uu____3185  ->
               let uu____3186 =
                 let uu____3193 = __exact_now set_expected_typ1 tm  in
                 catch uu____3193  in
         ...
         | FStar_Pervasives_Native.Some t ->
             ...
             (match uu____5613 with
              | (hd1,args) ->
                  let uu____5662 =
                    let uu____5677 =
                      let uu____5678 = FStar_Syntax_Subst.compress hd1  in
    ...
    FStar_Tactics_Monad.bind FStar_Tactics_Monad.cur_goal
      (fun g  ->
         ...
         let uu____7621 =
           ...
           FStar_Tactics_Monad.new_uvar "dup" env uu____7628  in
                    ...
                    let t1 =
                      let uu____7990 =
                        FStar_TypeChecker_Env.binders_of_bindings
                          (FStar_List.rev r1)
                         in
                      close_forall_no_univs1 uu____7990 phi1  in
                    let t2 =
                      let uu____8000 =
                        FStar_TypeChecker_Env.binders_of_bindings
                          (FStar_List.rev r2)
                         in
                      close_forall_no_univs1 uu____8000 phi2  in
                    let uu____8009 =
          ...
          (fun uu____8195  ->
             FStar_Tactics_Monad.bind FStar_Tactics_Monad.cur_goal
               (fun goal  ->
                  ...
                  let uu____8202 = __tc_ghost env tm  in
  ...
  fun env  ->
    fun ty  ->
            ...
            let uu____8286 =
              let uu____8293 =
                ...
                FStar_All.pipe_left FStar_Pervasives_Native.fst uu____8294
                 in
              FStar_Tactics_Monad.new_uvar "uvar_env.2" env uu____8293  in
      ...
      FStar_Tactics_Monad.bind uu____8280
        (fun typ  ->
           let uu____8323 = FStar_Tactics_Monad.new_uvar "uvar_env" env typ
              in
                      ...
                      let uu____10778 =
                        let uu____10783 =
                          let uu____10784 =
                            ...
                            FStar_Syntax_Syntax.mk_Tm_app hd1 uu____10789  in
          ...
          (match uu____12215 with
           | (ctx_uvar,uu____12229) ->
               let g =
                 ...
                 FStar_Tactics_Types.mk_goal env ctx_uvar uu____12231 false
                   ""
                  in
               (g, g_u))
...
let (tac_env : FStar_TypeChecker_Env.env -> FStar_TypeChecker_Env.env) =
  fun env  ->
    let uu____12240 = FStar_TypeChecker_Env.clear_expected_typ env  in
    match uu____12240 with
    | (env1,uu____12248) ->
        let env2 =
          let uu___1677_12254 = env1  in
          {
            FStar_TypeChecker_Env.solver =
...
let (proofstate_of_goal_ty :
  ...
  fun rng  ->
    fun env  ->
      fun typ  ->
        let env1 = tac_env env  in
        let uu____12319 = goal_of_goal_ty env1 typ  in
