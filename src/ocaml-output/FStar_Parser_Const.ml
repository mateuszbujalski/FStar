...
let (gen_reset : ((unit -> Prims.int) * (unit -> unit))) =
  ...
  let gen1 uu____1000 = FStar_Util.incr x; FStar_Util.read x  in
  let reset uu____1008 = FStar_Util.write x Prims.int_zero  in (gen1, reset) 
...
let (is_tuple_constructor_id : FStar_Ident.ident -> Prims.bool) =
  fun id1  ->
    let uu____1151 = FStar_Ident.text_of_id id1  in
...
let (mk_tuple_data_lid :
  ...
  fun n1  ->
    fun r  ->
      let t =
        let uu____1177 = FStar_Util.string_of_int n1  in
...
let (is_tuple_datacon_id : FStar_Ident.ident -> Prims.bool) =
  fun id1  ->
    let uu____1201 = FStar_Ident.text_of_id id1  in
...
let (is_tuple_data_lid : FStar_Ident.lident -> Prims.int -> Prims.bool) =
  fun f  ->
    fun n1  ->
      let uu____1226 = mk_tuple_data_lid n1 FStar_Range.dummyRange  in
...
let (mk_dtuple_lid : Prims.int -> FStar_Range.range -> FStar_Ident.lident) =
  fun n1  ->
    fun r  ->
      let t =
        let uu____1276 = FStar_Util.string_of_int n1  in
        FStar_Util.format1 "dtuple%s" uu____1276  in
      let uu____1279 = let uu____1280 = mod_prefix_dtuple n1  in uu____1280 t
         in
...
let (mk_dtuple_data_lid :
  ...
  fun n1  ->
    fun r  ->
      let t =
        let uu____1323 = FStar_Util.string_of_int n1  in
        FStar_Util.format1 "Mkdtuple%s" uu____1323  in
      let uu____1326 = let uu____1327 = mod_prefix_dtuple n1  in uu____1327 t
         in
...
let (is_dtuple_data_lid : FStar_Ident.lident -> Prims.int -> Prims.bool) =
  fun f  ->
    fun n1  ->
      let uu____1360 = mk_dtuple_data_lid n1 FStar_Range.dummyRange  in
