    ...
    fun table  ->
      fun evt  ->
        ...
        | NTAlias (host,id1,included) ->
            ...
            if uu____1052
            then
              let uu____1055 = FStar_Ident.text_of_id id1  in
        ...
        FStar_Syntax_DsEnv.ds_push_open_hook =
          (fun dsenv1  ->
             fun op  ->
               let uu____1291 =
                 let uu____1292 =
                   let uu____1297 = FStar_Syntax_DsEnv.current_module dsenv1
                      in
                   (uu____1297, op)  in
        ...
        FStar_Syntax_DsEnv.ds_push_include_hook =
          (fun dsenv1  ->
             fun ns  ->
               let uu____1303 =
                 let uu____1304 =
                   let uu____1309 = FStar_Syntax_DsEnv.current_module dsenv1
                      in
                   (uu____1309, ns)  in
    ...
    let set_hooks dshooks tchooks env1 =
      let uu____1384 =
        FStar_Universal.with_dsenv_of_tcenv env1
          (fun dsenv1  ->
             let uu____1392 = FStar_Syntax_DsEnv.set_ds_hooks dsenv1 dshooks
                in
             ((), uu____1392))
         in
      ...
      fun table  ->
        ...
        let loaded_mods_set =
          ...
          FStar_List.fold_left
            (fun acc  ->
               fun dep1  ->
                 let uu____2153 = FStar_Parser_Dep.lowercase_module_name dep1
                    in
