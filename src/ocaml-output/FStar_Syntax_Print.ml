...
let is_inr :
  'Auu____429 'Auu____430 .
    ('Auu____429,'Auu____430) FStar_Util.either -> Prims.bool
  =
  fun uu___1_440  ->
...
let filter_imp :
  'Auu____454 .
    ('Auu____454 * FStar_Syntax_Syntax.arg_qualifier
...
let rec find : 'a . ('a -> Prims.bool) -> 'a Prims.list -> 'a =
  fun f  ->
    fun l  ->
      ...
      | [] -> failwith "blah"
      | hd1::tl1 ->
          let uu____706 = f hd1  in if uu____706 then hd1 else find f tl1
...
let (version_to_string : FStar_Syntax_Syntax.version -> Prims.string) =
  fun v1  ->
    let uu____839 = FStar_Util.string_of_int v1.FStar_Syntax_Syntax.major  in
...
let rec (int_of_univ :
  ...
  fun n1  ->
    fun u  ->
      ...
      | uu____925 -> (n1, (FStar_Pervasives_Native.Some u))
    ...
    | FStar_Syntax_Syntax.U_succ u1 ->
        ...
        (match uu____961 with
         ...
         | (n1,FStar_Pervasives_Native.Some u2) ->
             ...
             let uu____984 = FStar_Util.string_of_int n1  in
    ...
    then
      ...
      (let x1 = FStar_Syntax_Subst.compress x  in
       ...
       | FStar_Syntax_Syntax.Tm_lazy
           ...
           let uu____1682 =
             let uu____1684 =
               let uu____1686 = FStar_Thunk.force thunk1  in
       ...
       | FStar_Syntax_Syntax.Tm_match (head1,branches) ->
           let uu____2419 = term_to_string head1  in
           let uu____2421 =
             let uu____2423 =
  ...
  fun x  ->
    let basic =
      ...
      | FStar_Syntax_Syntax.Sig_inductive_typ
          (lid,univs1,tps,k,uu____4050,uu____4051) ->
      ...
      | FStar_Syntax_Syntax.Sig_datacon
          (lid,univs1,t,uu____4084,uu____4085,uu____4086) ->
          let uu____4093 = FStar_Options.print_universes ()  in
          if uu____4093
          then
            let uu____4097 = univ_names_to_string univs1  in
      ...
      | FStar_Syntax_Syntax.Sig_declare_typ (lid,univs1,t) ->
          ...
          let uu____4118 =
            ...
            if uu____4120
            then
              let uu____4124 = univ_names_to_string univs1  in
      ...
      | FStar_Syntax_Syntax.Sig_fail (errs,lax1,ses) ->
          let uu____4202 = FStar_Util.string_of_bool lax1  in
          let uu____4204 =
            ...
            let uu____4237 =
              let uu____4242 =
                FStar_Syntax_Syntax.mk
                 ...
                 in
              FStar_Syntax_Subst.open_univ_vars univs1 uu____4242  in
             ...
             | (univs2,t) ->
                 ...
                 (match uu____4256 with
                  | (tps1,c1) ->
                      ...
                      let uu____4302 = univ_names_to_string univs2  in
      ...
      | FStar_Syntax_Syntax.Sig_polymonadic_bind (m,n1,p,t,ty) ->
          ...
          let uu____4348 = FStar_Ident.string_of_lid n1  in
