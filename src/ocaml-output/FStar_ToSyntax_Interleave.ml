          ...
          (FStar_List.collect
             (fun uu___0_122  ->
                ...
                | FStar_Parser_AST.TyconAbbrev
                    (id1,uu____126,uu____127,uu____128) ->
                    let uu____137 = FStar_Ident.lid_of_ids [id1]  in
                    [uu____137]
                | FStar_Parser_AST.TyconRecord
                    (id1,uu____139,uu____140,uu____141) ->
                    let uu____162 = FStar_Ident.lid_of_ids [id1]  in
                    [uu____162]
                | FStar_Parser_AST.TyconVariant
                    (id1,uu____164,uu____165,uu____166) ->
    ...
    let rec aux iface2 =
      ...
      | hd1::tl1 ->
          (match hd1.FStar_Parser_AST.d with
           ...
           | FStar_Parser_AST.Val (x,t) ->
               let uu____723 = FStar_Util.for_some (is_definition_of x) tl1
                  in
               if uu____723
               then
                 let uu____726 =
...
let (prefix_one_decl :
  ...
  fun mname  ->
    fun iface1  ->
      fun impl  ->
        match impl.FStar_Parser_AST.d with
        | FStar_Parser_AST.TopLevelModule uu____986 -> (iface1, [impl])
        | uu____991 ->
    ...
    fun impl  ->
      fun env  ->
        ...
        | FStar_Pervasives_Native.Some iface1 ->
            let uu____1114 = prefix_one_decl mname iface1 impl  in
            (match uu____1114 with
             | (iface2,impl1) ->
                 let env1 =
                   let uu____1140 = FStar_Syntax_DsEnv.current_module env  in
                   FStar_Syntax_DsEnv.set_iface_decls env uu____1140 iface2
                    in
                 (impl1, env1))
                   ...
                   FStar_List.fold_left
                     (fun uu____1223  ->
                        fun impl  ->
                          ...
                          | (iface2,impls1) ->
                              let uu____1251 = prefix_one_decl l iface2 impl
                                 in
