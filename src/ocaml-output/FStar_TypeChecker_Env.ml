...
let (should_verify : env -> Prims.bool) =
  fun env  ->
    ((Prims.op_Negation env.lax) && (Prims.op_Negation env.admit)) &&
      (let uu____14464 = FStar_Ident.string_of_lid env.curmodule  in
...
let new_sigtab : 'Auu____14501 . unit -> 'Auu____14501 FStar_Util.smap =
  fun uu____14508  -> FStar_Util.smap_create default_table_size 
let new_gamma_cache : 'Auu____14514 . unit -> 'Auu____14514 FStar_Util.smap =
...
let (push_stack : env -> env) =
  fun env  ->
    (let uu____15552 =
       let uu____15555 = FStar_ST.op_Bang stack  in env :: uu____15555  in
     FStar_ST.op_Colon_Equals stack uu____15552);
    (let uu___418_15604 = env  in
     let uu____15605 = FStar_Util.smap_copy (gamma_cache env)  in
     let uu____15608 = FStar_Util.smap_copy (sigtab env)  in
     let uu____15611 = FStar_Util.smap_copy (attrtab env)  in
     let uu____15618 =
       let uu____15633 =
         let uu____15637 =
     ...
     let uu____15718 = FStar_Util.smap_copy env.normalized_eff_names  in
     let uu____15721 = FStar_Util.smap_copy env.fv_delta_depths  in
     let uu____15724 =
       let uu____15727 = FStar_ST.op_Bang env.identifier_info  in
       FStar_Util.mk_ref uu____15727  in
     let uu____15747 = FStar_Util.smap_copy env.strict_args_tab  in
     let uu____15760 = FStar_Util.smap_copy env.erasable_types_tab  in
     {
...
let (push : env -> Prims.string -> env) =
  fun env  ->
    fun msg  ->
      let uu____16338 = snapshot env msg  in
...
let (incr_query_index : env -> env) =
  fun env  ->
    ...
    | (uu____16370,FStar_Pervasives_Native.None ) -> env
...
let (debug : env -> FStar_Options.debug_level_t -> Prims.bool) =
  fun env  ->
    fun l  ->
      let uu____16531 = FStar_Ident.string_of_lid env.curmodule  in
...
let (toggle_id_info : env -> Prims.bool -> unit) =
  fun env  ->
    fun enabled  ->
      let uu____16567 =
        let uu____16568 = FStar_ST.op_Bang env.identifier_info  in
        FStar_TypeChecker_Common.id_info_toggle uu____16568 enabled  in
      FStar_ST.op_Colon_Equals env.identifier_info uu____16567
...
let (insert_bv_info :
  ...
  fun env  ->
    fun bv  ->
      fun ty  ->
        let uu____16623 =
          let uu____16624 = FStar_ST.op_Bang env.identifier_info  in
          FStar_TypeChecker_Common.id_info_insert_bv uu____16624 bv ty  in
        FStar_ST.op_Colon_Equals env.identifier_info uu____16623
...
let (insert_fv_info :
  ...
  fun env  ->
    fun fv  ->
      fun ty  ->
        let uu____16679 =
          let uu____16680 = FStar_ST.op_Bang env.identifier_info  in
          FStar_TypeChecker_Common.id_info_insert_fv uu____16680 fv ty  in
        FStar_ST.op_Colon_Equals env.identifier_info uu____16679
...
let (promote_id_info :
  ...
  fun env  ->
    fun ty_map  ->
      let uu____16735 =
        let uu____16736 = FStar_ST.op_Bang env.identifier_info  in
        FStar_TypeChecker_Common.id_info_promote uu____16736 ty_map  in
      FStar_ST.op_Colon_Equals env.identifier_info uu____16735
...
let (find_in_sigtab :
  ...
  fun env  ->
    fun lid  ->
      ...
      FStar_Util.smap_try_find (sigtab env) uu____16831
...
let (variable_not_found :
  ...
  fun v1  ->
    let uu____16861 =
      let uu____16863 = FStar_Syntax_Print.bv_to_string v1  in
        ...
        (let uu____17220 =
         ...
         then
           ...
           let rec aux c l1 =
             ...
             | (uu____17277,[]) -> No
             | (hd1::tl1,hd'::tl') when
                 let uu____17296 = FStar_Ident.text_of_id hd1  in
                 let uu____17298 = FStar_Ident.text_of_id hd'  in
                 uu____17296 = uu____17298 -> aux tl1 tl'
             | uu____17301 -> No  in
           aux cur1 lns
         else No)
    ...
    fun lid  ->
      ...
      let cache t =
        (let uu____17353 = FStar_Ident.string_of_lid lid  in
         FStar_Util.smap_add (gamma_cache env) uu____17353 t);
      ...
      let found =
        ...
        then
          let uu____17397 =
            ...
            FStar_Util.smap_try_find (gamma_cache env) uu____17400  in
      ...
      then found
        ...
        (let uu____17848 = find_in_sigtab env lid  in
...
let (lookup_attr :
  ...
  fun env  ->
    fun attr  ->
      let uu____18064 = FStar_Util.smap_try_find (attrtab env) attr  in
  ...
  fun env  ->
    fun se  ->
      let add_one1 env1 se1 attr =
        let uu____18109 =
          let uu____18112 = lookup_attr env1 attr  in se1 :: uu____18112  in
        FStar_Util.smap_add (attrtab env1) attr uu____18109  in
      FStar_List.iter
        (fun attr  ->
           let uu____18122 =
      ...
      | uu____18162 ->
          ...
          (FStar_List.iter
             (fun l  ->
                ...
                FStar_Util.smap_add (sigtab env) uu____18170 se) lids;
      ...
      FStar_Util.find_map env.gamma
        (fun uu___4_18204  ->
           ...
           | FStar_Syntax_Syntax.Binding_var id1 when
               ...
               let uu____18214 =
                 let uu____18221 =
                   FStar_Ident.range_of_id id1.FStar_Syntax_Syntax.ppname  in
                 ((id1.FStar_Syntax_Syntax.sort), uu____18221)  in
          ...
          | (lr,rng) ->
              (match lr with
               ...
               | FStar_Util.Inr
                   ...
                   ->
                   let uu____18900 =
                     let uu____18902 = in_cur_mod env l  in uu____18902 = Yes
                      in
                   if uu____18900
                   then
                     let uu____18914 =
           ...
           in
        let uu____19384 =
          let uu____19395 = lookup_qname env lid  in
...
let (lid_exists : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun l  ->
      let uu____19540 = lookup_qname env l  in
...
let (lookup_bv :
  ...
  fun env  ->
    fun bv  ->
      ...
      let uu____19615 = try_lookup_bv env bv  in
...
let (try_lookup_lid :
  ...
  fun env  ->
    fun l  ->
      let uu____19670 = try_lookup_lid_aux FStar_Pervasives_Native.None env l
         in
      ...
      | FStar_Pervasives_Native.Some ((us,t),r) ->
          ...
          let r1 =
            let uu____19736 = FStar_Range.use_range use_range1  in
            FStar_Range.set_use_range r uu____19736  in
          let uu____19737 =
            let uu____19746 =
              let uu____19751 = FStar_Syntax_Subst.set_use_range use_range1 t
                 in
              (us, uu____19751)  in
            (uu____19746, r1)  in
    ...
    fun us  ->
      fun l  ->
        ...
        | FStar_Pervasives_Native.Some ((uu____19819,t),r) ->
            let use_range1 = FStar_Ident.range_of_lid l  in
            let r1 =
              let uu____19844 = FStar_Range.use_range use_range1  in
              FStar_Range.set_use_range r uu____19844  in
            let uu____19845 =
              let uu____19850 = FStar_Syntax_Subst.set_use_range use_range1 t
                 in
              (uu____19850, r1)  in
...
let (lookup_lid :
  ...
  fun env  ->
    fun l  ->
      let uu____19874 = try_lookup_lid env l  in
      ...
      FStar_All.pipe_right
        (FStar_List.find
           (fun uu___5_19952  ->
              ...
              | uu____19960 -> false) env.gamma) FStar_Option.isSome
...
let (try_lookup_val_decl :
  ...
  fun env  ->
    fun lid  ->
      let uu____19981 = lookup_qname env lid  in
...
let (lookup_val_decl :
  ...
  fun env  ->
    fun lid  ->
      let uu____20095 = lookup_qname env lid  in
...
let (lookup_datacon :
  ...
  fun env  ->
    fun lid  ->
      let uu____20191 = lookup_qname env lid  in
...
let (datacons_of_typ :
  ...
  fun env  ->
    fun lid  ->
      let uu____20299 = lookup_qname env lid  in
...
let (typ_of_datacon : env -> FStar_Ident.lident -> FStar_Ident.lident) =
  fun env  ->
    fun lid  ->
      let uu____20400 = lookup_qname env lid  in
...
let (lookup_definition :
  ...
  fun delta_levels  ->
    fun env  ->
      fun lid  ->
        let uu____20732 = lookup_qname env lid  in
...
let (lookup_nonrec_definition :
  ...
  fun delta_levels  ->
    fun env  ->
      fun lid  ->
        let uu____20765 = lookup_qname env lid  in
        FStar_All.pipe_left
                 ...
                 | FStar_Pervasives_Native.Some d ->
                     ((let uu____21117 =
                      ...
                      (let uu____21130 = FStar_Ident.string_of_lid lid  in
                       FStar_Util.smap_add env.fv_delta_depths uu____21130 d);
                      d))))
...
let (lookup_attrs_of_lid :
  ...
  fun env  ->
    fun lid  ->
      let uu____21295 = lookup_qname env lid  in
...
let (fv_exists_and_has_attr :
  ...
  fun env  ->
    fun fv_lid1  ->
      fun attr_lid  ->
        let uu____21328 = lookup_attrs_of_lid env fv_lid1  in
...
let (fv_with_lid_has_attr :
  ...
  fun env  ->
    fun fv_lid1  ->
      fun attr_lid  ->
        let uu____21388 = fv_exists_and_has_attr env fv_lid1 attr_lid  in
...
let rec (non_informative : env -> FStar_Syntax_Syntax.typ -> Prims.bool) =
  fun env  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_app (head1,uu____21546) ->
    ...
    fun fv  ->
      let f uu____21632 =
        let attrs =
          ...
          lookup_attrs_of_lid env uu____21638  in
        match attrs with
        | FStar_Pervasives_Native.None  ->
...
let (try_lookup_effect_lid :
  ...
  fun env  ->
    fun ftv  ->
      let uu____21723 = lookup_qname env ftv  in
...
let (lookup_effect_lid :
  ...
  fun env  ->
    fun ftv  ->
      let uu____21822 = try_lookup_effect_lid env ftv  in
...
let (lookup_effect_abbrev :
  ...
  fun env  ->
    fun univ_insts  ->
      fun lid0  ->
        let uu____21855 = lookup_qname env lid0  in
        ...
        | FStar_Pervasives_Native.Some
            (FStar_Util.Inr
             ({
                FStar_Syntax_Syntax.sigel =
                  FStar_Syntax_Syntax.Sig_effect_abbrev
                  (lid,univs1,binders,c,uu____21866);
            ...
            then FStar_Pervasives_Native.None
              ...
              (let insts =
                 ...
                 then univ_insts
                   ...
                   (let uu____21960 =
                      let uu____21962 =
                        let uu____21964 = get_range env  in
    ...
    fun l  ->
      ...
      let res =
        let uu____22186 =
          ...
          FStar_Util.smap_try_find env.normalized_eff_names uu____22189  in
        match uu____22186 with
        | FStar_Pervasives_Native.Some l1 -> l1
        | FStar_Pervasives_Native.None  ->
            let uu____22192 = find1 l  in
            (match uu____22192 with
             | FStar_Pervasives_Native.None  -> l
             | FStar_Pervasives_Native.Some m ->
                 ((let uu____22197 = FStar_Ident.string_of_lid l  in
                   FStar_Util.smap_add env.normalized_eff_names uu____22197 m);
                  m))
         in
...
let (num_effect_indices :
  ...
  fun env  ->
    fun name  ->
      fun r  ->
        let sig_t =
          let uu____22220 = FStar_All.pipe_right name (lookup_effect_lid env)
             in
...
let (lookup_effect_quals :
  ...
  fun env  ->
    fun l  ->
      ...
      let uu____22295 = lookup_qname env l1  in
  ...
  fun env  ->
    fun lid  ->
      fun i  ->
        ...
        let uu____22390 = lookup_datacon env lid  in
...
let (is_projector : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun l  ->
      let uu____22462 = lookup_qname env l  in
...
let (is_datacon : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun lid  ->
      let uu____22552 = lookup_qname env lid  in
...
let (is_record : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun lid  ->
      let uu____22640 = lookup_qname env lid  in
...
let (is_action : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun lid  ->
      let uu____22838 = lookup_qname env lid  in
...
let (is_interpreted : env -> FStar_Syntax_Syntax.term -> Prims.bool) =
  ...
  fun env  ->
    fun head1  ->
      let uu____22855 =
        let uu____22856 = FStar_Syntax_Util.un_uinst head1  in
...
let (is_irreducible : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun l  ->
      let uu____22881 = lookup_qname env l  in
    ...
    fun lid  ->
      let mapper x =
        ...
        | FStar_Util.Inr (se,uu____23032) ->
         ...
         in
      let uu____23080 =
        let uu____23084 = lookup_qname env lid  in
...
let (num_inductive_ty_params :
  ...
  fun env  ->
    fun lid  ->
      let uu____23144 = lookup_qname env lid  in
...
let (get_effect_decl :
  ...
  fun env  ->
    fun l  ->
      let uu____23299 = effect_decl_opt env l  in
...
let (is_layered_effect : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun l  ->
      let uu____23348 = FStar_All.pipe_right l (get_effect_decl env)  in
...
let (join :
  ...
  fun env  ->
    fun l1  ->
      fun l2  ->
        let uu____23585 = join_opt env l1 l2  in
        ...
        | FStar_Pervasives_Native.None  ->
            ...
            FStar_Errors.raise_error uu____23606 env.range
...
let wp_sig_aux :
  'Auu____23679 .
    (FStar_Syntax_Syntax.eff_decl * 'Auu____23679) Prims.list ->
      FStar_Ident.lident ->
           ...
           | (binders1,cdef1) ->
               (if
                ...
                (let inst1 =
                 ...
                 let c2 =
                   let uu____24125 =
                     let uu___1614_24126 = comp_to_comp_typ env c1  in
                     {
      ...
      fun c  ->
        fun u_res  ->
          let check_partial_application eff_name args =
            ...
            let uu____24179 =
              let uu____24186 = num_effect_indices env eff_name r  in
          ...
          let uu____24219 = effect_decl_opt env effect_name  in
              ...
              (match uu____24252 with
               ...
               | FStar_Pervasives_Native.Some ts ->
                   ...
                   (check_partial_application effect_name
                    ...
                    (let uu____24270 =
                       let uu____24273 = get_range env  in
                       let uu____24274 =
                         let uu____24281 =
                           let uu____24282 =
                             let uu____24299 =
  ...
  fun env  ->
    fun c  ->
      fun u_c  ->
        ...
        (let uu____24536 =
           let uu____24538 = is_reifiable_effect env l  in
         ...
         then
           ...
           let uu____24553 = get_range env  in
           FStar_Errors.raise_error uu____24541 uu____24553
         else ());
        (let uu____24556 = effect_repr_aux true env c u_c  in
...
let (push_new_effect :
  ...
  fun env  ->
    fun uu____24611  ->
      ...
      | (ed,quals) ->
          let effects =
            let uu___1700_24625 = env.effects  in
            {
          ...
          FStar_All.pipe_right (env.effects).polymonadic_binds
            (FStar_Util.find_opt
               (fun uu____24731  ->
                  ...
                  | (m1,n11,uu____24749,uu____24750) ->
        ...
        fun st_mlift  ->
            ...
            | (i,j) ->
                ...
                then
                  FStar_All.pipe_right (id_edge i)
                    (fun _25200  -> FStar_Pervasives_Native.Some _25200)
                else
                  ...
                  then
                    let uu____25328 =
                      ...
                      (FStar_Errors.Fatal_DivergentComputationCannotBeIncludedInTotal,
                        uu____25334)
                       in
                    let uu____25340 = get_range env  in
          ...
          (let joins =
             FStar_All.pipe_right ms
              ...
              in
           let effects =
             let uu___1824_25762 = env.effects  in
             {
        ...
        fun p  ->
          fun ty  ->
            let err_msg poly =
              ...
              let uu____25813 = FStar_Ident.string_of_lid n1  in
              ...
              FStar_Util.format4
               ...
               in
            let uu____25824 =
              let uu____25826 = exists_polymonadic_bind env m n1  in
            ...
            then
              let uu____25863 =
                ...
                (FStar_Errors.Fatal_PolymonadicBind_conflict, uu____25869)
                 in
              FStar_Errors.raise_error uu____25863 env.range
            else
              (let uu____25875 =
                 let uu____25877 = join_opt env m n1  in
               ...
               then
                 let uu____25902 =
                   ...
                   (FStar_Errors.Fatal_PolymonadicBind_conflict, uu____25908)
                    in
                 FStar_Errors.raise_error uu____25902 env.range
               else
                 (let uu___1842_25914 = env  in
                  {
                    ...
                    effects =
                      (let uu___1844_25916 = env.effects  in
                       {
  ...
  fun env  ->
    fun bs  ->
      FStar_List.fold_left
        (fun env1  ->
           fun uu____26076  ->
             match uu____26076 with | (x,uu____26084) -> push_bv env1 x) env
        bs
...
let (uvars_in_env : env -> FStar_Syntax_Syntax.uvars) =
  fun env  ->
    ...
    let rec aux out g =
      match g with
      | [] -> out
      | (FStar_Syntax_Syntax.Binding_univ uu____26378)::tl1 -> aux out tl1
      | (FStar_Syntax_Syntax.Binding_lid (uu____26382,(uu____26383,t)))::tl1
          ->
          let uu____26404 =
...
let (univ_vars : env -> FStar_Syntax_Syntax.universe_uvar FStar_Util.set) =
  fun env  ->
    ...
    let rec aux out g =
      match g with
      | [] -> out
      | (FStar_Syntax_Syntax.Binding_univ uu____26480)::tl1 -> aux out tl1
      | (FStar_Syntax_Syntax.Binding_lid (uu____26484,(uu____26485,t)))::tl1
          ->
          let uu____26506 =
  ...
  fun env  ->
    ...
    let rec aux out g =
      ...
      | (FStar_Syntax_Syntax.Binding_univ uname)::tl1 ->
          ...
          aux uu____26586 tl1
      | (FStar_Syntax_Syntax.Binding_lid (uu____26589,(uu____26590,t)))::tl1
          ->
          let uu____26611 =
...
let (should_enc_lid : env -> FStar_Ident.lident -> Prims.bool) =
  fun env  ->
    fun lid  ->
      ...
      should_enc_path env uu____27004
  ...
  fun env  ->
    let aux uu____27147 =
      ...
      | (p,b) ->
       ...
       in
    let uu____27175 =
      let uu____27179 = FStar_List.map aux env.proof_ns  in
          ...
          let uu____27486 =
            let uu____27487 =
              ...
              uu____27488 FStar_Pervasives_Native.None
               ...
               in
            FStar_All.pipe_left
              (fun _27561  -> FStar_TypeChecker_Common.NonTrivial _27561)
              uu____27487
             in
          {
  ...
  fun g  ->
    fun map1  ->
      ...
      | FStar_TypeChecker_Common.Trivial  ->
          ...
          let uu____27599 =
            let uu____27600 = map1 FStar_Syntax_Util.t_true  in
    ...
    fun binders  ->
      fun g  ->
        ...
        | FStar_TypeChecker_Common.NonTrivial f ->
            ...
            let uu____27757 =
              let uu____27758 = close_forall env binders f  in
                      ...
                      fun b  ->
                        ...
                        | (substs1,uvars1,g) ->
                            ...
                            let uu____28120 =
                              ...
                              new_implicit_var_aux uu____28133 r env sort
